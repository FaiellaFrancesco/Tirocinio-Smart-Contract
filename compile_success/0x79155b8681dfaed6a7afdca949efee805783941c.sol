/*
     POPE OF THE UNITED STATES

     https://x.com/PotusPope

     https://t.me/POTUS_POPE
...
contract POTUS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"POPE OF THE UNITED STATES";
    ...
    function manualSend(uint256 ethToSend) external {
        ...
        uint256 contractETHBalance = address(this).balance;
        sendETHFees(contractETHBalance);
    }
