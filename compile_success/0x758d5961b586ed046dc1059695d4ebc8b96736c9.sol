...
Powering the Future of AGI

Accelerate AI development, deployment, and commercialization through our secure AI Data Layer and seamless platforms - AI App Store, Co-Builder, and CeDePIN Cloud.

Web: https://grafi-ai.pro
Docs: https://docs.grafi-ai.pro

X: https://x.com/grafi_ai_pro
Tg: https://t.me/grafi_ai_pro
...
contract GRAFI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Grafi AI";
    string private constant _symbol = unicode"GRAFI";
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendGRAFIETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendGRAFIETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeeGRAFIForEth(uint256 tokenAmount) private lockTheSwap {
