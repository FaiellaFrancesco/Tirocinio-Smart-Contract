...
https://x.com/MellaH_Libra/status/1918738207828594939
https://t.me/Eaglecoin_erc20
...
contract Eaglecoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Make America Great Again in Eagle symbol";
    string private constant _symbol = unicode"Eaglecoin";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _setEaglecoinDurationBlock = 0;
    uint256 public _setEaglecoinDoubleTransferClick = 100;
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendEaglecoinETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendEaglecoinETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeeEaglecoinForEth(uint256 tokenAmount) private lockTheSwap {
