...
https://x.com/i/broadcasts/1vAxRDpYmgDGl
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KEKIUS GROKIUS";
    string private constant _symbol = unicode"KG";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot41(address a) public view returns (bool){
      return bots[a];
    }
