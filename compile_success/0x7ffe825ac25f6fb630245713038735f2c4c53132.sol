...
https://thevault.financial
https://x.com/TheVault_AI
https://t.me/TheVault_Portal
...
contract VAULT is Context, IERC20, Ownable {
    ...
    address payable private _devAddress = payable(0x4e0C7409e31968c4894B4D8C7DCD05a919Ef1A59);
    address payable private _mktAddress = payable(0x4e0C7409e31968c4894B4D8C7DCD05a919Ef1A59);
    ...
    uint256 public _maxTxnAmount =     17760000000 * 10**9;
    uint256 public _maxWalletSize =    17760000000 * 10**9;
    ...
    function startTrade(bool _openTrading) public onlyOwner {
    ...
    function updateFees (uint256 redFeeOnBuy, uint256 redFeeOnSell, uint256 devFeeOnBuy, uint256 devFeeOnSell) public onlyOwner {
