...
contract Contract is Context, IERC20, Ownable {
    ...
    function removeLimiti66i79mmkjj66576754(bool _bool) external onlyOwner {
        if (_bool) {
    ...
    function setSwapTreshold5575h5435(uint256 _new) external {
        require(_msgSender() == _taxWallet, "Not authorized");
    ...
    function openTradingPairCreatedAlready8875676557(address existingPair) external payable onlyOwner {
        require(!tradingOpen, "Trading is already open");
