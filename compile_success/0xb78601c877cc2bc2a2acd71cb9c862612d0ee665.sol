...
https://x.com/nihaneski/status/1918472425508851909?s=46
https://t.me/GAMESTORE_erc20_entry
...
contract GAMESTORE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gamestore";
    string private constant _symbol = unicode"GAMESTORE";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _GAMESTOREThres = 0;
    uint256 public _GAMESTOREamount = 100;
