...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"YC AI";
    string private constant _symbol = unicode"YCAI";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot36(address a) public view returns (bool){
      return bots[a];
    }
