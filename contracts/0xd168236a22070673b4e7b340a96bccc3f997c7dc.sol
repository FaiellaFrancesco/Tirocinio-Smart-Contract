...
Website: https://x.com/OnaraGoroEth

Telegram: https://t.me/OnaraGoroETH

X: https://x.com/OnaraGoroEth
...
contract Leverage is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Leverage Ai";
    string private constant _symbol = unicode"LEVERAGE";
    ...
    constructor () {
        _taxWallet = payable(0x404fB5F898a3F40D0dA8F0979D1f54bd7B275001);
