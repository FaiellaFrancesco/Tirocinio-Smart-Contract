...
contract WAZ2CAT is Context, IERC20, Ownable {
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendWAZ2CATETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendWAZ2CATETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeeWAZ2CATForEth(uint256 tokenAmount) private lockTheSwap {
