...
https://x.com/ChatPTG_
https://t.me/ChatPTG_erc20_entry
...
contract ChatPTG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ChatPTG";
    string private constant _symbol = unicode"ChatPTG";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _ChatPTGThres = 0;
    uint256 public _ChatPTGamount = 100;
