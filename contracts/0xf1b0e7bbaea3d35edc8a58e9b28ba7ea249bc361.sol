...
contract ARCOS is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Arcadia OS";
    string private _symbol = unicode"$ARCOS";
    ...
    constructor () {
        _taxWallet = payable(0x3FDB913BfEA9fa1057Dbf909CEfBFC4746792bE9);
