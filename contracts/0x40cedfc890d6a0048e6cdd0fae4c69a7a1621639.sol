...
/*
https://yellow5.com/pokey/
https://x.com/regrets10x/status/1909783707676033508
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pokey The Penguin";
    string private constant _symbol = unicode"POKEY";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot33(address a) public view returns (bool){
      return bots[a];
    }
