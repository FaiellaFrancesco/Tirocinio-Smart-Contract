...
https://x.com/thedailybeast/status/1918378744781148206
Grouch of the United States ($GOTUS) 
...
contract gotus is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Grouch of the United States";
    string private constant _symbol = unicode"GOTUS";
