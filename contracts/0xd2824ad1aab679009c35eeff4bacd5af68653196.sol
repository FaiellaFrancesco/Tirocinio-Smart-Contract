...
contract SolmaxToken is Context, IERC20, Ownable {
    string private constant _name = "Solmax Token";
    string private constant _symbol = "SXT";
    ...
    function tokenBurn(uint256 amount) external {
        require(_balance[msg.sender] >= amount, "Not enough tokens to burn");
