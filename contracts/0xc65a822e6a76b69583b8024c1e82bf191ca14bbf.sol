...
https://x.com/dogecoin/status/1910312934376689793
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Doge Van";
    string private constant _symbol = unicode"DOGEVAN";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot48(address a) public view returns (bool){
      return bots[a];
    }
