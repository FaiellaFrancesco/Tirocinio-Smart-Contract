/*
Web: https://dbunker-ai.xyz
X: https://x.com/Dbunker_AI
Tg: https://t.me/Dbunker_AI
*/
...
contract DAI is Context, IERC20, Ownable {
    ...
    uint256 private _buyDAICount = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10 **_decimals;
    string private constant _name = unicode"Dbunker AI";
    string private constant _symbol = unicode"DAI";
    uint256 public _maxDAITaxSwap = _tTotal / 100;
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                {
                    uint256 swapBalance = contractTokenBalance > _maxDAITaxSwap
                        ? _maxDAITaxSwap
    ...
    function rescueDAITOKNETH() external onlyOwner {
