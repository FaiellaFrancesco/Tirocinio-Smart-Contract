...
https://www.youtube.com/watch?v=BKIunICSC4At=173s
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump Siri";
    string private constant _symbol = unicode"DONNY";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot39(address a) public view returns (bool){
      return bots[a];
    }
