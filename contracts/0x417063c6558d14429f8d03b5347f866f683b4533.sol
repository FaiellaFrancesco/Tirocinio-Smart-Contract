...
contract SyloraAI is Context, IERC20, Ownable {
    ...
    address payable private _taxDevelopment;
    ...
    constructor () {
        _taxDevelopment = payable(_msgSender());
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxDevelopment] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _taxDevelopment.transfer(amount);
    }

    function manualSwap() external {
        require(_msgSender()==_taxDevelopment);
