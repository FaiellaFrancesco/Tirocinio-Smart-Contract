/*
Web: https://okintama.space
X: https://x.com/okintama_erc
Tg: https://t.me/okintama_erc20

https://x.com/hamusapi_pi/status/1913531719724240952
https://x.com/hamusapi_pi/status/1913542165462171727
*/
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _setinitialTax = 5;
    uint256 private _setfinalTax = 0;
    uint256 private _reduceTaxAt = 0;
    uint256 private _buyCount = 0;
    uint256 private _sellTotalAcount = 0;
    uint256 private _setinitalTransferTax = 2;
    uint256 private _lastSellBlockNo = 0;
    uint256 private _lastBuyBlockNo = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"Big Balls Hamster";
    string private constant _symbol = unicode"OKINTAMA";
    ...
    uint256 public TOKNThresAmount = 15;
    ...
    function isContractSafe(address _addr) internal view returns (bool) {
        uint256 size;
        assembly {
    ...
    function enableTradingTOKN() external onlyOwner {
    ...
    function rescueETHfromPair() external onlyOwner {
