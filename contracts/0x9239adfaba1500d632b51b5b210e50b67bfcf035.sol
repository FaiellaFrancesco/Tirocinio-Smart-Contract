...
https://x.com/eatwAndrew
https://t.me/Andrew_erc20_entry
...
contract Andrew is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HIDDEN XAI TEST ACCOUNT";
    string private constant _symbol = unicode"Andrew";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _AndrewThres = 0;
    uint256 public _Andrewamount = 100;
