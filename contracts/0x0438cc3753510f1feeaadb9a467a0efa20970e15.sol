...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"XDVIDEO";
    string private constant _symbol = unicode"XDVIDEO";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot51(address a) public view returns (bool){
      return bots[a];
    }
