/*
Web: https://wormsbymattfurie.xyz
X: https://x.com/worms_coin
Tg: https://t.me/WormsByMattFurie_Eth
*/
...
contract WORMS is Context, IERC20, Ownable {
    ...
    uint256 private _buyWORMSCount = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10 **_decimals;
    string private constant _name = unicode"Worms by Matt Furie";
    string private constant _symbol = unicode"WORMS";
    uint256 public _maxWORMSTaxSwap = _tTotal / 100;
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                {
                    uint256 swapBalance = contractTokenBalance > _maxWORMSTaxSwap
                        ? _maxWORMSTaxSwap
    ...
    function rescueWORMSTOKNETH() external onlyOwner {
