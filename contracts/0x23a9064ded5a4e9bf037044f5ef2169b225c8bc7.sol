...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ask Grok";
    string private constant _symbol = unicode"ASKGROK";
    ...
    function launchAskGrok() external onlyOwner {
