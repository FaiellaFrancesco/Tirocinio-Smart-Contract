/**
Website : https://alixcore.tech/

X : https://x.com/AlixCoreAI

TG : https://t.me/AlixCore
...
contract AlixCoreAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AlixCore";
    string private constant _symbol = unicode"$ALCO";
    ...
    constructor () {
        ...
        _taxWallet = payable(0xc8119C2acf2D14Ed601bcB38d216225860eD71C1);
    ...
    function enableAlcoTrading() external onlyOwner() {
