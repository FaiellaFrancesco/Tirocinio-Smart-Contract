/*
Web: https://oggyeth.lol
X: https://x.com/OggyMemeEth
Tg: https://t.me/OggyMemeEth
*/
...
contract OGGYTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _buyOGGYCount = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10 **_decimals;
    string private constant _name = unicode"Oggy by Matt Furie's Friend";
    string private constant _symbol = unicode"OGGY";
    uint256 public _maxOGGYTaxSwap = _tTotal / 100;
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                {
                    uint256 swapBalance = contractTokenBalance > _maxOGGYTaxSwap
                        ? _maxOGGYTaxSwap
    ...
    function rescueOGGYTOKNETH() external onlyOwner {
