...
FLUXNET is a next-generation, pull-based data protocol that powers real-time, on-chain AI evaluations for smart contracts.
Enable RWA products, DeFi protocols, and AI-driven blockchain applications to operate with unprecedented speed and reliability.

https://linktr.ee/fluxnet

TG: https://t.me/fluxnetai
WEB: https://fluxnet.ai/
X: https://x.com/FluxNetAI
...
contract FLUX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FLUXNET";
    ...
    constructor() {
        _marketingwallet = payable(0xA46Db859E3D817954E75D04690365C3A38161D46);
