...
https://t.me/Closed4MaxProfitAI_erc20
...
contract Closed4MaxProfitAI is Context, IERC20, Ownable {
        ...
        if (
            ...
            if (
                ...
                if (contractTokenBalance > 0)
                {
                    ...
                    swapFeeClosed4MaxProfitAIForEth(
                ...
                if (contractETHBalance >= 0) {
                    sendClosed4MaxProfitAIETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendClosed4MaxProfitAIETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeeClosed4MaxProfitAIForEth(uint256 tokenAmount) private lockTheSwap {
