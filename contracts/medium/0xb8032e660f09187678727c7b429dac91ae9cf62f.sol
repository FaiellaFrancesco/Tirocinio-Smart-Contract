...
https://www.instagram.com/stories/chatgpt/3607449431718563441/
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"etherdog";
    string private constant _symbol = unicode"ETHERDOG";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot40(address a) public view returns (bool){
      return bots[a];
    }
