...
https://x.com/Whale_AI_net
https://t.me/WHAI_erc20_entry
...
contract WHAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WhaleAI";
    string private constant _symbol = unicode"WHAI";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _WHAIThres = 0;
    uint256 public _WHAIamount = 100;
