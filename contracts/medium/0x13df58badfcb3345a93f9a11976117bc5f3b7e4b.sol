...
https://x.com/gork/status/1918692334872756464
https://t.me/JpegAI_erc20_entry
...
contract JpegAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JpegAI";
    string private constant _symbol = unicode"JpegAI";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _JpegAIThres = 0;
    uint256 public _JpegAIamount = 100;
