...
https://x.com/EPavlic/status/1918654196401746223
https://www.worldanimalprotection.ca/take-action/petition-free-baloo/
https://t.me/BALOO_erc20_entry
...
contract BALOO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FREE BALOO";
    string private constant _symbol = unicode"BALOO";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _BALOOThres = 0;
    uint256 public _BALOOamount = 100;
