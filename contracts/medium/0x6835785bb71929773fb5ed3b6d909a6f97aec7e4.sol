...
/*
https://metixai.site
https://app.metixai.site
https://x.com/metixaieth
https://t.me/metixai_portal
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _initialMETIXATax = 10;
    uint256 private _finalMETIXATax = 0;
    uint256 private _reduceMETIXATaxAt = 0;
    ...
    string private constant _name = unicode"Metix AI";
    string private constant _symbol = unicode"METIX";
    ...
    function _transfer(
        ...
        if (
            ...
            if (!inSwap) {
                taxAmount = amount
                    .mul((_buyCount > _reduceMETIXATaxAt) ? _finalMETIXATax : _initialMETIXATax)
                    .div(100);
            }
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                require(
                    _blockBuyAmount < _getMETIXAAmountOut() ||
                        _lastBuyBlock != block.number,
                    "Max Swap Limit"
                );
            }
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendTokenETHToMETIXAFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendTokenETHToMETIXAFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapMETIXAFeeTokensForEth(uint256 tokenAmount) private lockTheSwap {
    ...
    function rescueMETIXAETH() external onlyOwner {
    ...
    function _getMETIXAAmountOut() internal view returns (uint256) {
        address[] memory path = new address[](2);
