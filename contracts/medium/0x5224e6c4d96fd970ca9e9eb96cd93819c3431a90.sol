/*
Dexcision 
Trade crypto and real-world assets with confidence through a fast, 
decentralized binary options platform built for the future.

TG: https://t.me/DexcisionErc
X: https://x.com/dexnofficial?s=21&t=AAeulnrJ8097JIfGWHF2cQ
Web: https://dexcision.xyz

Gitbook: https://dexcision.gitbook.io/dexcision/
*/
...
contract Dexcision is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dexcision";
    string private constant _symbol = unicode"DEXN";
