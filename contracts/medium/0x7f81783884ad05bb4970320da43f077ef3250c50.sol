...
https://x.com/PressSec/status/1918447473820877022/photo/1
https://t.me/MOGNALD_erc20_entry
...
contract MOGNALD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MOGNALD TRUMP";
    string private constant _symbol = unicode"MOGNALD";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _MOGNALDThres = 0;
    uint256 public _MOGNALDamount = 100;
