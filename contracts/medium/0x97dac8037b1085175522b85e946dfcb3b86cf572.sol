...
https://nesa-ai.network
https://beta.nesa-ai.network
https://explorer-test.nesa-ai.network

https://x.com/nesa_ai_net
https://t.me/nesa_ai_net
...
contract NESA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nesa AI";
    string private constant _symbol = unicode"NESA";
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendNESAETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendNESAETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeeNESAForEth(uint256 tokenAmount) private lockTheSwap {
