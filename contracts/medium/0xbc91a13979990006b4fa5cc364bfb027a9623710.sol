...
https://maps.app.goo.gl/1nTQj1V37Je2ybnf6
https://t.me/Frank_erc20_entry
...
contract Frank is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Frank The Cat";
    string private constant _symbol = unicode"Frank";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _FrankThres = 0;
    uint256 public _Frankamount = 100;
