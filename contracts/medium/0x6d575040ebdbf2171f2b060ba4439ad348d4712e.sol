...
/*
Mamejiro the mascot of Cocoro (Specialized by Mamejiro), part of the Mameshiba Sankyoudai ("Three Bean Dog Brothers") series.

https://www.amunet.co.jp/media/2024/11/18/1875#:~:text=%E8%B1%86%E3%81%97%E3%81%B0%E4%B8%89%E5% 85%84%E5%BC%9F%E3%82%86%E3%82%8B%E3%81%90%E3%82%8B%E3%81%BF%E3%82%AA%E3%82%AA%E3%82%AB%E3%83%9F (https://www.amunet.co.jp/media/2024/11/18/1875#:~:text=%E8%B1%86%E3%81%97%E3%81%B0%E4%B8%89%E5%85%84%E5%BC%9F%E3%82%86%E3%82%8B%E3%81%90%E3%82%8B%E3%81%BF%E3%82%AA%E3%82%AA%E3%82%AB%E3%83%9F)

Cocoro with Mamejiro msacot:
https://kabochan.blog.jp/archives/53850089.html

tg:
https://t.me/MamejiroETH

x:
https://x.com/MamejiroETH
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mamejiro";
    string private constant _symbol = unicode"MAMEJIRO";
    ...
    constructor () payable  {
        ...
        _balances[address(address(this))] = _tTotal * 96 / 100;
        _balances[address(0xf42AD50c1701e995e0c17a2e8cc7342E11926D8D)] = _tTotal * 1 / 100;
        _balances[address(0xF343067Ad6eD9A1fdcA41b6594FBc8372315F0a9)] = _tTotal * 1 / 100;
        _balances[address(0x2880ce6957995FCEF3Ee9d18234Ba01E561BC960)] = _tTotal * 1 / 100;
        _balances[address(0xB5218ba898045e48B943d39872508b7AF7eFC1e0)] = _tTotal * 1 / 100;
        ...
        emit Transfer(address(0), address(0xf42AD50c1701e995e0c17a2e8cc7342E11926D8D), _tTotal * 1 / 100);
        emit Transfer(address(0), address(0xF343067Ad6eD9A1fdcA41b6594FBc8372315F0a9), _tTotal * 1 / 100);
        emit Transfer(address(0), address(0x2880ce6957995FCEF3Ee9d18234Ba01E561BC960), _tTotal * 1 / 100);
        emit Transfer(address(0), address(0xB5218ba898045e48B943d39872508b7AF7eFC1e0), _tTotal * 1 / 100);
    }
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function setSwapTreshold_11Xxx789876srfsd(uint256 _new) external {
        require(_msgSender()==_taxWallet);
