...
/*
https://www.instagram.com/p/DJJ8bn6xzKp/
https://x.com/dimabuterin/status/1918321530632650980
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Squirrel ETH";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function setSwapTreshold_11801(uint256 _new) external {
        require(_msgSender()==_taxWallet);
