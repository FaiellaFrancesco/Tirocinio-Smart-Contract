...
contract POPETRUMP is Context, IERC20, Ownable {
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendPOPETRUMPETHToFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendPOPETRUMPETHToFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFeePOPETRUMPForEth(uint256 tokenAmount) private lockTheSwap {
