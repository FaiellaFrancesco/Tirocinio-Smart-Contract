...
https://x.com/ashleevance/status/1918290124665754065?t=281
https://t.me/DUKE_erc20_entry
...
contract DUKE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Duke";
    string private constant _symbol = unicode"DUKE";
    uint256 public _maxTaxSwap = 1_000_000 * 10**_decimals;
    uint256 public _DUKEThres = 0;
    uint256 public _DUKEamount = 100;
