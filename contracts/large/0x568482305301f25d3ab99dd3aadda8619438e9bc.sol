...
contract ETHRN is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public ETHRN;

    bool private swapping;

    address public marketingWallet;
    address public ETHRNWallet;
    ...
    constructor() ERC20(unicode"ETHRN", unicode"ETHRN") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        // #################################################################
        marketingWallet = address(0x883e62e95D1028380D2FC182E155B076527BD832); // set as marketing wallet
        ETHRNWallet = address(0x883e62e95D1028380D2FC182E155B076527BD832); // set as dev wallet
        // #################################################################
        ...
        uint256 _buyETHRNTax = 0;

        uint256 _sellMarketingTax = 20;
        uint256 _sellLiqTax = 0;
        uint256 _sellETHRNTax = 0;

        uint256 _earlySellLiqTax = 0;
        uint256 _earlySellMarketingTax = 0;

        uint256 totalSupply = 21000000000000 * 1e18;

        maxTransactionAmount = (totalSupply * 5) / 1000; // .5% maxtransaction
        ...
        buyETHRNTax = _buyETHRNTax;
        buyTotalTaxs = buyMarketingTax + buyLiqTax + buyETHRNTax;

        sellMarketingTax = _sellMarketingTax;
        sellLiqTax = _sellLiqTax;
        sellETHRNTax = _sellETHRNTax;
        sellTotalTaxs = sellMarketingTax + sellLiqTax + sellETHRNTax;
    ...
    function updateMarketingWallet(
        ...
        function set_ETHRN(address new_ETHRN_address) external onlyOwner {
        ETHRN = new_ETHRN_address;
    }

    function updateETHRNWallet(address newWallet) external onlyOwner {
        emit ETHRNWalletUpdated(newWallet, ETHRNWallet);
        ETHRNWallet = newWallet;
    }
    ...
    function _transfer(
        ...
        if (takeTax) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalTaxs > 0) {
                ...
                tokensForDev += (Taxs * sellETHRNTax) / sellTotalTaxs;
            ...
            // on buy
                ...
                tokensForDev += (Taxs * buyETHRNTax) / buyTotalTaxs;
    ...
    function swapBack() private {
        ...
        (success, ) = address(ETHRNWallet).call{value: ethForDev}("");
