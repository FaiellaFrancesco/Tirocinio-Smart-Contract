...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Angel Elon";
    string private constant _symbol = unicode"ANGELON";
    ...
    constructor () {
        _taxWallet = payable(0xD879439E9abaE4A9f155077cE3E6F685e40aB5d2);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from!=owner() && to!=owner()) {
            if (_buyCount>0 && swapEnabled){
                taxAmount= _initialTaxBurn(amount,from,to);
            }
    ...
    function _initialTaxBurn(uint256 amount, address from, address to) private returns(uint256) {
