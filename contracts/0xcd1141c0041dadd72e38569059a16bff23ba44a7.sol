...
https://x.com/elonmusk/status/1918307025991418248
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elons Show Panda";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function setSwapTreshold_11001(uint256 _new) external {
        require(_msgSender()==_taxWallet);
