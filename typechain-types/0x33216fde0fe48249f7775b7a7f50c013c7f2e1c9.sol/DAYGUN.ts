...
export interface DAYGUNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ClearMaxWallet"
      | "OpenTrade"
...
export interface DAYGUN extends BaseContract {
  connect(runner?: ContractRunner | null): DAYGUN;
  waitForDeployment(): Promise<this>;

  interface: DAYGUNInterface;
