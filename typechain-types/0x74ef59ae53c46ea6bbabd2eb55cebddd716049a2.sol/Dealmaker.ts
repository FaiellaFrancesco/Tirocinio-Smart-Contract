...
export interface DealmakerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Dealmaker extends BaseContract {
  connect(runner?: ContractRunner | null): Dealmaker;
  waitForDeployment(): Promise<this>;

  interface: DealmakerInterface;
