...
export interface TOKEN extends BaseContract {
  ...
  enableZKML: TypedContractMethod<[], [void], "nonpayable">;
  ...
  rescueZKMLETH: TypedContractMethod<[], [void], "nonpayable">;
