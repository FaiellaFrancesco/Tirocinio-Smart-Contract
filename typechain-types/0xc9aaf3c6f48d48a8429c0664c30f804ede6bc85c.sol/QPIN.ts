...
export interface QPINInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_BuyTax"
      | "_SellTax"
...
export interface QPIN extends BaseContract {
  connect(runner?: ContractRunner | null): QPIN;
  ...
  removeBots: TypedContractMethod<
    [addresses: AddressLike[]],
    [void],
    "nonpayable"
  >;
