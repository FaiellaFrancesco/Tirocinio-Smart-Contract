...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "rescueMATTIUS961XXETH",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Token extends BaseContract {
  ...
  rescueMATTIUS961XXETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "rescueMATTIUS961XXETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
