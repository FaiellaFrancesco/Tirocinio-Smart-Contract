...
export interface PSTOCKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
  ...
  encodeFunctionData(
    functionFragment: "triggerLogicLoop",
    values?: undefined
  ): string;
...
export interface PSTOCK extends BaseContract {
  connect(runner?: ContractRunner | null): PSTOCK;
  waitForDeployment(): Promise<this>;

  interface: PSTOCKInterface;
  ...
  triggerLogicLoop: TypedContractMethod<[], [boolean], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "triggerLogicLoop"
