...
export interface BabyPepeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface BabyPepe extends BaseContract {
  connect(runner?: ContractRunner | null): BabyPepe;
  waitForDeployment(): Promise<this>;

  interface: BabyPepeInterface;
