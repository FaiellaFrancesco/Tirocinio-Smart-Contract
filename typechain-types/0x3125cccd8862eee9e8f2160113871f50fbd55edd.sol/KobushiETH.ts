...
export interface KobushiETHInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface KobushiETH extends BaseContract {
  connect(runner?: ContractRunner | null): KobushiETH;
  waitForDeployment(): Promise<this>;

  interface: KobushiETHInterface;
  ...
  ): TypedContractMethod<[ethToSend: BigNumberish], [void], "nonpayable">;
  getFunction(
