...
export interface UnifyAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface UnifyAI extends BaseContract {
  connect(runner?: ContractRunner | null): UnifyAI;
  waitForDeployment(): Promise<this>;

  interface: UnifyAIInterface;
