...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "rescueClosed4MaxProfitAIETH",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Token extends BaseContract {
  ...
  rescueClosed4MaxProfitAIETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "rescueClosed4MaxProfitAIETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
