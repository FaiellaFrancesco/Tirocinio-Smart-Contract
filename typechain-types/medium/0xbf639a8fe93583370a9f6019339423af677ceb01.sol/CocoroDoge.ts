...
export interface CocoroDogeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CocoroDoge extends BaseContract {
  connect(runner?: ContractRunner | null): CocoroDoge;
  waitForDeployment(): Promise<this>;

  interface: CocoroDogeInterface;
