...
export interface CHESTERInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ClearMaxWallet"
      | "OpenTrade"
  ...
  encodeFunctionData(
    functionFragment: "ClearMaxWallet",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(functionFragment: "clearClog", values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: "takeoutStuckETH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "clearClog", data: BytesLike): Result;
...
export interface CHESTER extends BaseContract {
  connect(runner?: ContractRunner | null): CHESTER;
  waitForDeployment(): Promise<this>;

  interface: CHESTERInterface;
  ...
  ClearMaxWallet: TypedContractMethod<[], [void], "nonpayable">;
  ...
  clearClog: TypedContractMethod<[], [void], "nonpayable">;
  ...
  takeoutStuckETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "ClearMaxWallet"
  ...
  getFunction(
    nameOrSignature: "takeoutStuckETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
