...
export interface ShookyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Shooky extends BaseContract {
  connect(runner?: ContractRunner | null): Shooky;
  waitForDeployment(): Promise<this>;

  interface: ShookyInterface;
