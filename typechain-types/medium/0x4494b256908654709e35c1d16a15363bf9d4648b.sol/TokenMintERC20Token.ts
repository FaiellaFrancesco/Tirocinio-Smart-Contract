...
export interface TokenMintERC20TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface TokenMintERC20Token extends BaseContract {
  connect(runner?: ContractRunner | null): TokenMintERC20Token;
  waitForDeployment(): Promise<this>;

  interface: TokenMintERC20TokenInterface;
