...
export interface SuperGrokInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface SuperGrok extends BaseContract {
  connect(runner?: ContractRunner | null): SuperGrok;
  waitForDeployment(): Promise<this>;

  interface: SuperGrokInterface;
