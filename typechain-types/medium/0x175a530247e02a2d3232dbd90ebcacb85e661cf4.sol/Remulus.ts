...
export interface RemulusInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Remulus extends BaseContract {
  connect(runner?: ContractRunner | null): Remulus;
  waitForDeployment(): Promise<this>;

  interface: RemulusInterface;
