...
export interface DATBOIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface DATBOI extends BaseContract {
  connect(runner?: ContractRunner | null): DATBOI;
  waitForDeployment(): Promise<this>;

  interface: DATBOIInterface;
