...
export interface GROYDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface GROYD extends BaseContract {
  connect(runner?: ContractRunner | null): GROYD;
  waitForDeployment(): Promise<this>;

  interface: GROYDInterface;
