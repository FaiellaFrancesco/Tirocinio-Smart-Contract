...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "sjEther", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "sjToken",
    values: [AddressLike, BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "sjEther", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "sjToken", data: BytesLike): Result;
...
export interface Token extends BaseContract {
  ...
  sjEther: TypedContractMethod<[], [void], "nonpayable">;

  sjToken: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "sjEther"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "sjToken"
  ): TypedContractMethod<
    [_address: AddressLike, percent: BigNumberish],
    [void],
    "nonpayable"
