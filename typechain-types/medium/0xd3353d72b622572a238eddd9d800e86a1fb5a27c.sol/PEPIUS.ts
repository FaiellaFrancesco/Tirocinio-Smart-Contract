...
export interface PEPIUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "OpenTrending"
      | "_maxTaxSwap"
  ...
  encodeFunctionData(
    functionFragment: "removeTaxLimitTransfers",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PEPIUS extends BaseContract {
  connect(runner?: ContractRunner | null): PEPIUS;
  waitForDeployment(): Promise<this>;

  interface: PEPIUSInterface;
  ...
  OpenTrending: TypedContractMethod<[], [void], "nonpayable">;
  ...
  removeTaxLimitTransfers: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "manualXxx"
  ): TypedContractMethod<[tokenBalance: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "removeTaxLimitTransfers"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
