...
export interface PEPIUSInterface extends utils.Interface {
  functions: {
    ...
    "removeTaxLimitTransfers()": FunctionFragment;
...
export interface PEPIUS extends BaseContract {
  ...
  callStatic: {
    ...
    removeTaxLimitTransfers(overrides?: CallOverrides): Promise<void>;
