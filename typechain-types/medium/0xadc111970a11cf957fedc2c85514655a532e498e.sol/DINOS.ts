...
export interface DINOSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface DINOS extends BaseContract {
  connect(runner?: ContractRunner | null): DINOS;
  waitForDeployment(): Promise<this>;

  interface: DINOSInterface;
