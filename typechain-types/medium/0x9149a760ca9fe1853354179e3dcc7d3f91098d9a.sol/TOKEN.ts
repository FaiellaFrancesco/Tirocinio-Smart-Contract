...
export interface TOKENInterface extends utils.Interface {
  functions: {
    "TOKNThresAmount()": FunctionFragment;
    ...
    "rescueETHfromPair()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TOKNThresAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "rescueETHfromPair",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TOKEN extends BaseContract {
  ...
  functions: {
    TOKNThresAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    rescueETHfromPair(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    TOKNThresAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
