...
export interface ElonMaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ElonMa extends BaseContract {
  connect(runner?: ContractRunner | null): ElonMa;
  waitForDeployment(): Promise<this>;

  interface: ElonMaInterface;
