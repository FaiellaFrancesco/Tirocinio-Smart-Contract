...
export interface CocoroPepeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CocoroPepe extends BaseContract {
  connect(runner?: ContractRunner | null): CocoroPepe;
  waitForDeployment(): Promise<this>;

  interface: CocoroPepeInterface;
