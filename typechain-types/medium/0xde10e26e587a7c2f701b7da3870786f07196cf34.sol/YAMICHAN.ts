...
export interface YAMICHANInterface extends utils.Interface {
  functions: {
...
export interface YAMICHAN extends BaseContract {
  ...
  callStatic: {
    ...
    manualSw(overrides?: CallOverrides): Promise<void>;
