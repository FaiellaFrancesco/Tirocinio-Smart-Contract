...
export interface Closed4MaxProfitAIInterface extends utils.Interface {
  functions: {
    "_Closed4MaxProfitAIThres()": FunctionFragment;
    "_Closed4MaxProfitAIamount()": FunctionFragment;
...
export interface Closed4MaxProfitAI extends BaseContract {
  ...
  functions: {
    _Closed4MaxProfitAIThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _Closed4MaxProfitAIamount(overrides?: CallOverrides): Promise<[BigNumber]>;
