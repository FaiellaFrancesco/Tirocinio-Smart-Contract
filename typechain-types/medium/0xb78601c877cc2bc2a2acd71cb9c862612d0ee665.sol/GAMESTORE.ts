...
export interface GAMESTOREInterface extends utils.Interface {
  functions: {
    "_GAMESTOREThres()": FunctionFragment;
    "_GAMESTOREamount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_GAMESTOREThres",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_GAMESTOREamount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GAMESTORE extends BaseContract {
  ...
  functions: {
    _GAMESTOREThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _GAMESTOREamount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _GAMESTOREThres(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _GAMESTOREamount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
