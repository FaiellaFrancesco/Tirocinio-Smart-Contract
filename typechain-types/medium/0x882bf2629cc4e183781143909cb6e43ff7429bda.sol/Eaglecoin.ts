...
export interface EaglecoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_setEaglecoinDoubleTransferClick"
      | "_setEaglecoinDurationBlock"
      | "allowance"
      | "approve"
      | "balanceOf"
      | "decimals"
  ...
  encodeFunctionData(
    functionFragment: "_setEaglecoinDoubleTransferClick",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_setEaglecoinDurationBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Eaglecoin extends BaseContract {
  connect(runner?: ContractRunner | null): Eaglecoin;
  waitForDeployment(): Promise<this>;

  interface: EaglecoinInterface;
  ...
  _setEaglecoinDoubleTransferClick: TypedContractMethod<[], [bigint], "view">;

  _setEaglecoinDurationBlock: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "_setEaglecoinDoubleTransferClick"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "_setEaglecoinDurationBlock"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
