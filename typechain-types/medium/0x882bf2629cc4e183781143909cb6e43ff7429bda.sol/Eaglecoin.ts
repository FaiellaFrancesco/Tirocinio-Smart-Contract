...
export interface EaglecoinInterface extends utils.Interface {
  functions: {
    ...
    "_setEaglecoinDoubleTransferClick()": FunctionFragment;
    "_setEaglecoinDurationBlock()": FunctionFragment;
...
export interface Eaglecoin extends BaseContract {
  ...
  functions: {
    ...
    _setEaglecoinDurationBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
