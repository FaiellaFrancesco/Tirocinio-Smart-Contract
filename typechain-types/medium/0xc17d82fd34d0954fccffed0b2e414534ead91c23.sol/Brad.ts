...
export interface BradInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Brad extends BaseContract {
  connect(runner?: ContractRunner | null): Brad;
  waitForDeployment(): Promise<this>;

  interface: BradInterface;
