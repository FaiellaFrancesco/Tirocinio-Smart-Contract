...
export interface AlixCoreAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "RemoveRestrictions"
      | "RenounceOwnership"
...
export interface AlixCoreAI extends BaseContract {
  connect(runner?: ContractRunner | null): AlixCoreAI;
  ...
  enableAlcoTrading: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "enableAlcoTrading"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
