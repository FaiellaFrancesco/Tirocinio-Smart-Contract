...
export interface AlixCoreAIInterface extends utils.Interface {
  functions: {
    ...
    "enableAlcoTrading()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "enableAlcoTrading",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface AlixCoreAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlixCoreAIInterface;
  ...
  callStatic: {
    ...
    enableAlcoTrading(overrides?: CallOverrides): Promise<void>;
