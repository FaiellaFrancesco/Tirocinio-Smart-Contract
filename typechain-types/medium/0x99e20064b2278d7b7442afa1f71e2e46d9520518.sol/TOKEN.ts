...
export interface TOKENInterface extends utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "launchLYWV", data: BytesLike): Result;
...
export interface TOKEN extends BaseContract {
  ...
  callStatic: {
    ...
    launchLYWV(overrides?: CallOverrides): Promise<void>;
