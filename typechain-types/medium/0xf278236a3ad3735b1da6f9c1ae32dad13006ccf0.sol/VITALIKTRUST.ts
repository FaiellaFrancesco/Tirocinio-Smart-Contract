...
export interface VITALIKTRUSTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface VITALIKTRUST extends BaseContract {
  connect(runner?: ContractRunner | null): VITALIKTRUST;
  waitForDeployment(): Promise<this>;

  interface: VITALIKTRUSTInterface;
  ...
  marketingAddress: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "marketingAddress"
  ...
  ): TypedContractMethod<[weiAmount: BigNumberish], [void], "nonpayable">;
  getFunction(
