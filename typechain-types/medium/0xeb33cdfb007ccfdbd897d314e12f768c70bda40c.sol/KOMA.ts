...
export interface KOMAInterface extends utils.Interface {
  functions: {
...
export interface KOMA extends BaseContract {
  ...
  callStatic: {
    ...
    renounceOwnershipKoma(overrides?: CallOverrides): Promise<void>;
