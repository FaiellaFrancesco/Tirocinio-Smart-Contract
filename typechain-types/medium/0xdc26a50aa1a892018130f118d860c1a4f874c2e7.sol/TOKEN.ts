...
export interface TOKENInterface extends utils.Interface {
  functions: {
    "_TOKNThresAmount()": FunctionFragment;
    "_maxTaxSwap()": FunctionFragment;
    "addETHtoContract()": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "decimals()": FunctionFragment;
    "enableTradingTOKN()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_TOKNThresAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "addETHtoContract",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "enableTradingTOKN",
    values?: undefined
  ): string;
...
export interface TOKEN extends BaseContract {
  ...
  functions: {
    _TOKNThresAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    addETHtoContract(overrides?: CallOverrides): Promise<void>;
    ...
    enableTradingTOKN(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    _TOKNThresAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
