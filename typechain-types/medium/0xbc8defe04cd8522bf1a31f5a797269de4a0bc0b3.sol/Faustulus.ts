...
export interface FaustulusInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Faustulus extends BaseContract {
  connect(runner?: ContractRunner | null): Faustulus;
  waitForDeployment(): Promise<this>;

  interface: FaustulusInterface;
