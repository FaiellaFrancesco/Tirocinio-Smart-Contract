...
export interface JusticecatInterface extends utils.Interface {
  functions: {
    "_justicecatThres()": FunctionFragment;
    "_justicecatamount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_justicecatThres",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_justicecatamount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Justicecat extends BaseContract {
  ...
  functions: {
    _justicecatThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _justicecatamount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _justicecatThres(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _justicecatamount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
