...
export interface ETHCHANInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ETHCHAN extends BaseContract {
  connect(runner?: ContractRunner | null): ETHCHAN;
  waitForDeployment(): Promise<this>;

  interface: ETHCHANInterface;
