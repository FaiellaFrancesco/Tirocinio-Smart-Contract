...
export interface TOKEN extends BaseContract {
  ...
  TOKNThresAmount: TypedContractMethod<[], [bigint], "view">;
  ...
  enableTradingTOKN: TypedContractMethod<[], [void], "nonpayable">;
  ...
  rescueETHfromPair: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "TOKNThresAmount"
  ...
  getFunction(
    nameOrSignature: "enableTradingTOKN"
  ...
  getFunction(
    nameOrSignature: "rescueETHfromPair"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
