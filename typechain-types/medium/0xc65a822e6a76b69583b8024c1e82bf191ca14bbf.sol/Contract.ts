...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot48", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot48: TypedContractMethod<[a: AddressLike], [boolean], "view">;
