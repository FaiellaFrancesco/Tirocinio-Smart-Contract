...
export interface BEMUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface BEMUS extends BaseContract {
  connect(runner?: ContractRunner | null): BEMUS;
  waitForDeployment(): Promise<this>;

  interface: BEMUSInterface;
