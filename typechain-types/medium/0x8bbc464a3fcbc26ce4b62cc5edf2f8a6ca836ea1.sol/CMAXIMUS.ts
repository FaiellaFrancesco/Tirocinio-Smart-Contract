...
export interface CMAXIMUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CMAXIMUS extends BaseContract {
  connect(runner?: ContractRunner | null): CMAXIMUS;
  waitForDeployment(): Promise<this>;

  interface: CMAXIMUSInterface;
