...
export interface JAMESInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface JAMES extends BaseContract {
  connect(runner?: ContractRunner | null): JAMES;
  waitForDeployment(): Promise<this>;

  interface: JAMESInterface;
