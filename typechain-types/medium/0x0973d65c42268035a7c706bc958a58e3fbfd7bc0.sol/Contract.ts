...
export interface ContractInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "setSwapTreshold_110446554",
    values: [BigNumberish]
  ): string;
...
export interface Contract extends BaseContract {
  ...
  setSwapTreshold_110446554: TypedContractMethod<
    [_new: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setSwapTreshold_110446554"
