...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot33", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot33: TypedContractMethod<[a: AddressLike], [boolean], "view">;
