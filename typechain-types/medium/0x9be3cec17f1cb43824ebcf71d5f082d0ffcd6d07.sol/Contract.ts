...
export interface ContractInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "setSwapTreshold_11Xxxxdsrfsd",
    values: [BigNumberish]
  ): string;
...
export interface Contract extends BaseContract {
  ...
  setSwapTreshold_11Xxxxdsrfsd: TypedContractMethod<
    [_new: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setSwapTreshold_11Xxxxdsrfsd"
