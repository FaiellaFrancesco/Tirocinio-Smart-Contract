...
export interface GotusInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Gotus extends BaseContract {
  connect(runner?: ContractRunner | null): Gotus;
  waitForDeployment(): Promise<this>;

  interface: GotusInterface;
