...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "recoverStuckETH",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "recoverStuckToken",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Token extends BaseContract {
  ...
  recoverStuckETH: TypedContractMethod<[], [void], "nonpayable">;

  recoverStuckToken: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "recoverStuckETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "recoverStuckToken"
  ): TypedContractMethod<
    [_address: AddressLike, percent: BigNumberish],
    [void],
    "nonpayable"
