...
export interface SALLYInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface SALLY extends BaseContract {
  connect(runner?: ContractRunner | null): SALLY;
  waitForDeployment(): Promise<this>;

  interface: SALLYInterface;
