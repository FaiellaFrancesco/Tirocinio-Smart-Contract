...
export interface MakeshowersgreatagainInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Makeshowersgreatagain extends BaseContract {
  connect(runner?: ContractRunner | null): Makeshowersgreatagain;
  waitForDeployment(): Promise<this>;

  interface: MakeshowersgreatagainInterface;
