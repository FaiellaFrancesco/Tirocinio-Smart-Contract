...
export interface GorkInterface extends utils.Interface {
  functions: {
    "_gorkThres()": FunctionFragment;
    "_gorkamount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_gorkThres",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_gorkamount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_gorkThres", data: BytesLike): Result;
...
export interface Gork extends BaseContract {
  ...
  functions: {
    _gorkThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _gorkamount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _gorkThres(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _gorkamount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
