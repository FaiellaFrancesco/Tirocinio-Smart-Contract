...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot41", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot41: TypedContractMethod<[a: AddressLike], [boolean], "view">;
