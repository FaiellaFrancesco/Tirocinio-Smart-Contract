...
export interface MokaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface Moka extends BaseContract {
  connect(runner?: ContractRunner | null): Moka;
  waitForDeployment(): Promise<this>;

  interface: MokaInterface;
