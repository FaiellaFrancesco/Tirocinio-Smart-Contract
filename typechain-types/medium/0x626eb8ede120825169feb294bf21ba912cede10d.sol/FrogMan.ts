...
export interface FrogManInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface FrogMan extends BaseContract {
  connect(runner?: ContractRunner | null): FrogMan;
  waitForDeployment(): Promise<this>;

  interface: FrogManInterface;
