...
export interface ClosedMaxProfitAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ClosedMaxProfitAI extends BaseContract {
  connect(runner?: ContractRunner | null): ClosedMaxProfitAI;
  waitForDeployment(): Promise<this>;

  interface: ClosedMaxProfitAIInterface;
