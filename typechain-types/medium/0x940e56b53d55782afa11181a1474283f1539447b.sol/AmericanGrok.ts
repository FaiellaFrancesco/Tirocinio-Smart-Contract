...
export interface AmericanGrokInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface AmericanGrok extends BaseContract {
  connect(runner?: ContractRunner | null): AmericanGrok;
  waitForDeployment(): Promise<this>;

  interface: AmericanGrokInterface;
