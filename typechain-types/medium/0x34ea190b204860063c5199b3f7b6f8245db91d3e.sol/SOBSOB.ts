...
export interface SOBSOBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface SOBSOB extends BaseContract {
  connect(runner?: ContractRunner | null): SOBSOB;
  waitForDeployment(): Promise<this>;

  interface: SOBSOBInterface;
