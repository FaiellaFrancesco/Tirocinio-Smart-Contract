...
export interface RIGGEDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface RIGGED extends BaseContract {
  connect(runner?: ContractRunner | null): RIGGED;
  waitForDeployment(): Promise<this>;

  interface: RIGGEDInterface;
  ...
  allowance: TypedContractMethod<
    [ownerAddr: AddressLike, spender: AddressLike],
    [bigint],
    "view"
  >;
