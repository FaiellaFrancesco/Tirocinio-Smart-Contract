...
export interface JUSTICECATInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
  ...
  encodeFunctionData(
    functionFragment: "recoverContractETH",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface JUSTICECAT extends BaseContract {
  connect(runner?: ContractRunner | null): JUSTICECAT;
  waitForDeployment(): Promise<this>;

  interface: JUSTICECATInterface;
  ...
  recoverContractETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "recoverContractETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
