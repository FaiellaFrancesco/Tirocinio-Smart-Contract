...
export interface JUSTICECATInterface extends utils.Interface {
  functions: {
    "_bots(address)": FunctionFragment;
    ...
    "recoverContractETH()": FunctionFragment;
...
export interface JUSTICECAT extends BaseContract {
  ...
  _bots(a: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
  ...
  callStatic: {
    ...
    recoverContractETH(overrides?: CallOverrides): Promise<void>;
