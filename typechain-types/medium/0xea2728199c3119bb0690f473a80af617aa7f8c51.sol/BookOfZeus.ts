...
export interface BookOfZeusInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BookOfZeus extends BaseContract {
  connect(runner?: ContractRunner | null): BookOfZeus;
  waitForDeployment(): Promise<this>;

  interface: BookOfZeusInterface;
