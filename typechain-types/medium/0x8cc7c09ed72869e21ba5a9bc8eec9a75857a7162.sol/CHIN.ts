...
export interface CHINInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CHIN extends BaseContract {
  connect(runner?: ContractRunner | null): CHIN;
  waitForDeployment(): Promise<this>;

  interface: CHINInterface;
