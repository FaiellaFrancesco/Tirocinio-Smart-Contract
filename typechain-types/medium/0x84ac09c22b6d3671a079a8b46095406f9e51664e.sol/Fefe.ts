...
export interface FefeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Fefe extends BaseContract {
  connect(runner?: ContractRunner | null): Fefe;
  waitForDeployment(): Promise<this>;

  interface: FefeInterface;
