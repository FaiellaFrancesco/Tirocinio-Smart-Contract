...
export interface EaglecoinInterface extends utils.Interface {
  functions: {
    "_EaglecoinThres()": FunctionFragment;
    "_Eaglecoinamount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_EaglecoinThres",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_Eaglecoinamount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Eaglecoin extends BaseContract {
  ...
  functions: {
    _EaglecoinThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _Eaglecoinamount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _EaglecoinThres(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _Eaglecoinamount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
