...
export interface CATIInterface extends utils.Interface {
  functions: {
    ...
    "rescueERC20(uint256)": FunctionFragment;
    "rescueETH()": FunctionFragment;
    "sellLimit()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "sellLimit", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "sellLimit", data: BytesLike): Result;
...
export interface CATI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CATIInterface;
  ...
  functions: {
    ...
    sellLimit(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    sellLimit(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    sellLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
