...
export interface MoonFinderCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface MoonFinderCoin extends BaseContract {
  connect(runner?: ContractRunner | null): MoonFinderCoin;
  waitForDeployment(): Promise<this>;

  interface: MoonFinderCoinInterface;
