...
export interface PepiusaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
  ...
  encodeFunctionData(
    functionFragment: "removeTransTax",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Pepiusa extends BaseContract {
  connect(runner?: ContractRunner | null): Pepiusa;
  waitForDeployment(): Promise<this>;

  interface: PepiusaInterface;
  ...
  removeTransTax: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "removeTransTax"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
