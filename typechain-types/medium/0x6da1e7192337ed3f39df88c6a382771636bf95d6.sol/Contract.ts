...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot46", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot46: TypedContractMethod<[a: AddressLike], [boolean], "view">;
