...
export interface HUMANBONKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface HUMANBONK extends BaseContract {
  connect(runner?: ContractRunner | null): HUMANBONK;
  waitForDeployment(): Promise<this>;

  interface: HUMANBONKInterface;
