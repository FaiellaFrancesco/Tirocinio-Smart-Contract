...
export interface BTCDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface BTCD extends BaseContract {
  connect(runner?: ContractRunner | null): BTCD;
  waitForDeployment(): Promise<this>;

  interface: BTCDInterface;
