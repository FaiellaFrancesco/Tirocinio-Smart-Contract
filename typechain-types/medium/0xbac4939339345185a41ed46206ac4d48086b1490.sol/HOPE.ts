...
export interface HOPEInterface extends utils.Interface {
  functions: {
    "_HOPEThres()": FunctionFragment;
    "_HOPEamount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_HOPEThres",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_HOPEamount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_HOPEThres", data: BytesLike): Result;
...
export interface HOPE extends BaseContract {
  ...
  functions: {
    _HOPEThres(overrides?: CallOverrides): Promise<[BigNumber]>;

    _HOPEamount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _HOPEThres(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _HOPEamount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
