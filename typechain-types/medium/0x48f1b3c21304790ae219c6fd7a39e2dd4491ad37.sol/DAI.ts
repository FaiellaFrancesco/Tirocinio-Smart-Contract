...
export interface DAIInterface extends utils.Interface {
  functions: {
    "_maxDAITaxSwap()": FunctionFragment;
    ...
    "rescueDAITOKNETH()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_maxDAITaxSwap",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "rescueDAITOKNETH",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DAI extends BaseContract {
  ...
  functions: {
    _maxDAITaxSwap(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    rescueDAITOKNETH(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    _maxDAITaxSwap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
