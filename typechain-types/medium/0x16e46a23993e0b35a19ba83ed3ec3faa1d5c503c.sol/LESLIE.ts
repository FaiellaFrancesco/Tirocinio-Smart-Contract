...
export interface LESLIEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface LESLIE extends BaseContract {
  connect(runner?: ContractRunner | null): LESLIE;
  waitForDeployment(): Promise<this>;

  interface: LESLIEInterface;
