...
export interface PSTOCKInterface extends utils.Interface {
  functions: {
    ...
    "clearStuckERC20(address,uint256)": FunctionFragment;
    ...
    "triggerLogicLoop()": FunctionFragment;
  };
...
export interface PSTOCK extends BaseContract {
  ...
  functions: {
    ...
    triggerLogicLoop(overrides?: CallOverrides): Promise<[boolean]>;
  };
  ...
  estimateGas: {
    ...
    triggerLogicLoop(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    triggerLogicLoop(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
