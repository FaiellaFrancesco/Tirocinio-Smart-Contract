...
export interface FreeVirgilGriffithInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface FreeVirgilGriffith extends BaseContract {
  connect(runner?: ContractRunner | null): FreeVirgilGriffith;
  waitForDeployment(): Promise<this>;

  interface: FreeVirgilGriffithInterface;
