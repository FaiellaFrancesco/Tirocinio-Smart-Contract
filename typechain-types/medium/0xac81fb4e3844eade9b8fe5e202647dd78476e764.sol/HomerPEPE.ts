...
export interface HomerPEPEInterface extends utils.Interface {
  functions: {
    "_buyCount()": FunctionFragment;
    "_finalBuyTax()": FunctionFragment;
    "_finalSellTax()": FunctionFragment;
...
export interface HomerPEPE extends BaseContract {
  ...
  functions: {
    _buyCount(overrides?: CallOverrides): Promise<[BigNumber]>;

    _finalBuyTax(overrides?: CallOverrides): Promise<[BigNumber]>;

    _finalSellTax(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    _buyCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _finalBuyTax(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _finalSellTax(overrides?: CallOverrides): Promise<PopulatedTransaction>;
