...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot35", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot35: TypedContractMethod<[a: AddressLike], [boolean], "view">;
