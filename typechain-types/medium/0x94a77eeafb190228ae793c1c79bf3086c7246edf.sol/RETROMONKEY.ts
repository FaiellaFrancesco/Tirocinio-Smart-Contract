...
export interface RETROMONKEYInterface extends utils.Interface {
  functions: {
...
export interface RETROMONKEY extends BaseContract {
  ...
  callStatic: {
    ...
    removeTrasnferLimits(overrides?: CallOverrides): Promise<void>;
