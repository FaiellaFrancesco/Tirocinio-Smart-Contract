...
export interface ELONARDOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ELONARDO extends BaseContract {
  connect(runner?: ContractRunner | null): ELONARDO;
  waitForDeployment(): Promise<this>;

  interface: ELONARDOInterface;
