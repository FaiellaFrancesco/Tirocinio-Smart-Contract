...
export interface PICOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface PICO extends BaseContract {
  connect(runner?: ContractRunner | null): PICO;
  ...
  isB: TypedContractMethod<[a: AddressLike], [boolean], "view">;
  ...
  startTrade: TypedContractMethod<[], [void], "nonpayable">;
