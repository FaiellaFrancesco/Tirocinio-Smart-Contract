...
export interface PICOInterface extends utils.Interface {
  functions: {
    ...
    "rmvTransferTax()": FunctionFragment;
...
export interface PICO extends BaseContract {
  ...
  isB(a: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
  ...
  callStatic: {
    ...
    rmvTransferTax(overrides?: CallOverrides): Promise<void>;
