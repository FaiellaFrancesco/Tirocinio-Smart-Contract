...
export interface WereSoBackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface WereSoBack extends BaseContract {
  connect(runner?: ContractRunner | null): WereSoBack;
  waitForDeployment(): Promise<this>;

  interface: WereSoBackInterface;
