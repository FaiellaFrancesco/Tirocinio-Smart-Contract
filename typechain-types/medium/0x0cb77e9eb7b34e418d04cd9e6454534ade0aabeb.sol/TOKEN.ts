...
export interface TOKENInterface extends utils.Interface {
  functions: {
    ...
    "launchBGBVGH()": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "removeLimits()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "rescueETHFROMGVV()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rescueETHFROMGVV",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TOKEN extends BaseContract {
  ...
  callStatic: {
    ...
    launchBGBVGH(overrides?: CallOverrides): Promise<void>;
    ...
    rescueETHFROMGVV(overrides?: CallOverrides): Promise<void>;
