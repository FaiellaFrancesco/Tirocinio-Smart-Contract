...
export interface LETHIMCOOKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface LETHIMCOOK extends BaseContract {
  connect(runner?: ContractRunner | null): LETHIMCOOK;
  waitForDeployment(): Promise<this>;

  interface: LETHIMCOOKInterface;
