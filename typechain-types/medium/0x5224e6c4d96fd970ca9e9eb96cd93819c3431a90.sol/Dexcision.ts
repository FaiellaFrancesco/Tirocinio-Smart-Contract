...
export interface DexcisionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Dexcision extends BaseContract {
  connect(runner?: ContractRunner | null): Dexcision;
  waitForDeployment(): Promise<this>;

  interface: DexcisionInterface;
