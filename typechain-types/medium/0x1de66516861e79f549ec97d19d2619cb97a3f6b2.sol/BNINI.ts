...
export interface BNINIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface BNINI extends BaseContract {
  connect(runner?: ContractRunner | null): BNINI;
  waitForDeployment(): Promise<this>;

  interface: BNINIInterface;
