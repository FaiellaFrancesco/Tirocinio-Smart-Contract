...
export interface ROFLEXInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ROFLEX extends BaseContract {
  connect(runner?: ContractRunner | null): ROFLEX;
  waitForDeployment(): Promise<this>;

  interface: ROFLEXInterface;
