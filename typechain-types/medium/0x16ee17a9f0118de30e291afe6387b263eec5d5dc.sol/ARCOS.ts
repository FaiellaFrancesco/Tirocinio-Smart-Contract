...
export interface ARCOSInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "NameUpdated(string,string)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "SymbolUpdated(string,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SymbolUpdated"): EventFragment;
...
export interface SymbolUpdatedEventObject {
  oldSymbol: string;
  newSymbol: string;
}
export type SymbolUpdatedEvent = TypedEvent<
  [string, string],
  SymbolUpdatedEventObject
>;

export type SymbolUpdatedEventFilter = TypedEventFilter<SymbolUpdatedEvent>;
...
export interface ARCOS extends BaseContract {
  ...
  filters: {
    ...
    NameUpdated(oldName?: null, newName?: null): NameUpdatedEventFilter;
    ...
    "SymbolUpdated(string,string)"(
      oldSymbol?: null,
      newSymbol?: null
    ): SymbolUpdatedEventFilter;
    SymbolUpdated(oldSymbol?: null, newSymbol?: null): SymbolUpdatedEventFilter;
