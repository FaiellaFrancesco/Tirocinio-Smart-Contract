...
export interface MCTRUMPInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface MCTRUMP extends BaseContract {
  connect(runner?: ContractRunner | null): MCTRUMP;
  waitForDeployment(): Promise<this>;

  interface: MCTRUMPInterface;
