...
export interface TokenInterface extends utils.Interface {
  functions: {
    "_finalTokenTransferDurationBlock()": FunctionFragment;
    "_initTokenDurationBlock()": FunctionFragment;
    ...
    "rescueTokenETH()": FunctionFragment;
...
export interface Token extends BaseContract {
  ...
  functions: {
    ...
    _initTokenDurationBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    rescueTokenETH(overrides?: CallOverrides): Promise<void>;
