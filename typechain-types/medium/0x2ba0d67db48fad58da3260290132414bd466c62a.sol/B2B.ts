...
export interface B2BInterface extends utils.Interface {
  functions: {
...
export interface B2B extends BaseContract {
  ...
  functions: {
    ...
    launched(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    launched(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    launched(overrides?: CallOverrides): Promise<PopulatedTransaction>;
