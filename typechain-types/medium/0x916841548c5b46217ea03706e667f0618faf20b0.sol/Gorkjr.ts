...
export interface GorkjrInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Gorkjr extends BaseContract {
  connect(runner?: ContractRunner | null): Gorkjr;
  waitForDeployment(): Promise<this>;

  interface: GorkjrInterface;
