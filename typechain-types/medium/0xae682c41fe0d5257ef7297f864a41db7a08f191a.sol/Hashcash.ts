...
export interface HashcashInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Launch"
      | "_maxTaxSwap"
...
export interface Hashcash extends BaseContract {
  connect(runner?: ContractRunner | null): Hashcash;
  waitForDeployment(): Promise<this>;

  interface: HashcashInterface;
