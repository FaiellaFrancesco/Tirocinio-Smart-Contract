...
export interface ContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "name"
      | "openTrading"
      | "openTradingPairCreatedAlready8877"
      | "owner"
      | "reduceFee"
  ...
  encodeFunctionData(
    functionFragment: "openTradingPairCreatedAlready8877",
    values: [AddressLike]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setSwapTreshold5575h5435",
    values: [BigNumberish]
  ): string;
...
export interface Contract extends BaseContract {
  ...
  openTradingPairCreatedAlready8877: TypedContractMethod<
  ...
  setSwapTreshold5575h5435: TypedContractMethod<
    [_new: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "openTradingPairCreatedAlready8877"
  ...
  >;
  getFunction(
    nameOrSignature: "setSwapTreshold5575h5435"
