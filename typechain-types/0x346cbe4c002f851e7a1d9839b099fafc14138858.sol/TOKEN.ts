...
export interface TOKEN extends BaseContract {
  ...
  launchMetaData: TypedContractMethod<[], [void], "nonpayable">;
  ...
  rescueDFEIRETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "launchMetaData"
  ...
  getFunction(
    nameOrSignature: "rescueDFEIRETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
