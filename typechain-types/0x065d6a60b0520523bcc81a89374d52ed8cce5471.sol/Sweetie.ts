...
export interface SweetieInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Sweetie extends BaseContract {
  connect(runner?: ContractRunner | null): Sweetie;
  waitForDeployment(): Promise<this>;

  interface: SweetieInterface;
