...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot51", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot51: TypedContractMethod<[a: AddressLike], [boolean], "view">;
