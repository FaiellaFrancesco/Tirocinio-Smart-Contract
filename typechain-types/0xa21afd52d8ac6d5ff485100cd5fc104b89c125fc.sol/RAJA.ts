...
export interface RAJAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface RAJA extends BaseContract {
  connect(runner?: ContractRunner | null): RAJA;
  waitForDeployment(): Promise<this>;

  interface: RAJAInterface;
