...
export interface GORKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface GORK extends BaseContract {
  connect(runner?: ContractRunner | null): GORK;
  waitForDeployment(): Promise<this>;

  interface: GORKInterface;
