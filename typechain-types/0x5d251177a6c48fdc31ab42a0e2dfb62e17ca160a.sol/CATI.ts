...
export interface CATIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CATI extends BaseContract {
  connect(runner?: ContractRunner | null): CATI;
  ...
  sellLimit: TypedContractMethod<[], [boolean], "view">;
