...
export interface ElonInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Elon extends BaseContract {
  connect(runner?: ContractRunner | null): Elon;
  waitForDeployment(): Promise<this>;

  interface: ElonInterface;
