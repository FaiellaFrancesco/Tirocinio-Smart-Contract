...
export interface PAOPAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface PAOPAO extends BaseContract {
  connect(runner?: ContractRunner | null): PAOPAO;
  waitForDeployment(): Promise<this>;

  interface: PAOPAOInterface;
