...
export interface NOVARICInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MODE_NORMAL"
      | "MODE_OWNER_ONLY"
...
export interface NOVARIC extends BaseContract {
  connect(runner?: ContractRunner | null): NOVARIC;
  ...
  MODE_OWNER_ONLY: TypedContractMethod<[], [bigint], "view">;

  MODE_RESTRICTED: TypedContractMethod<[], [bigint], "view">;
  ...
  setMode: TypedContractMethod<[mode: BigNumberish], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "MODE_OWNER_ONLY"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "MODE_RESTRICTED"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
