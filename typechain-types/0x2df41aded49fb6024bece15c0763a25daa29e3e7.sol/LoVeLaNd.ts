...
export interface LoVeLaNdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface LoVeLaNd extends BaseContract {
  connect(runner?: ContractRunner | null): LoVeLaNd;
  waitForDeployment(): Promise<this>;

  interface: LoVeLaNdInterface;
