...
export class VitalikWorld__factory extends ContractFactory {
  ...
  ): Promise<VitalikWorld> {
    return super.deploy(overrides || {}) as Promise<VitalikWorld>;
  }
  ...
  override attach(address: string): VitalikWorld {
    return super.attach(address) as VitalikWorld;
  }
  override connect(signer: Signer): VitalikWorld__factory {
    return super.connect(signer) as VitalikWorld__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VitalikWorldInterface {
    return new utils.Interface(_abi) as VitalikWorldInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VitalikWorld {
    return new Contract(address, _abi, signerOrProvider) as VitalikWorld;
  }
}
