...
export class RIGGED__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<RIGGED>;
  }
  ...
  override attach(address: string): RIGGED {
    return super.attach(address) as RIGGED;
  }
  override connect(signer: Signer): RIGGED__factory {
    return super.connect(signer) as RIGGED__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RIGGEDInterface {
    return new utils.Interface(_abi) as RIGGEDInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RIGGED {
    return new Contract(address, _abi, signerOrProvider) as RIGGED;
  }
}
