...
export class NeuroXOracle__factory extends ContractFactory {
  ...
  ): Promise<NeuroXOracle> {
    return super.deploy(overrides || {}) as Promise<NeuroXOracle>;
  }
  ...
  override attach(address: string): NeuroXOracle {
    return super.attach(address) as NeuroXOracle;
  }
  override connect(signer: Signer): NeuroXOracle__factory {
    return super.connect(signer) as NeuroXOracle__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): NeuroXOracleInterface {
    return new utils.Interface(_abi) as NeuroXOracleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NeuroXOracle {
    return new Contract(address, _abi, signerOrProvider) as NeuroXOracle;
  }
}
