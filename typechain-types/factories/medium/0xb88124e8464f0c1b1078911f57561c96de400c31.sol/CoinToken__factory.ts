...
export class CoinToken__factory extends ContractFactory {
  ...
  override attach(address: string): CoinToken {
    return super.attach(address) as CoinToken;
  }
  override connect(signer: Signer): CoinToken__factory {
    return super.connect(signer) as CoinToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CoinTokenInterface {
    return new utils.Interface(_abi) as CoinTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CoinToken {
    return new Contract(address, _abi, signerOrProvider) as CoinToken;
  }
}
