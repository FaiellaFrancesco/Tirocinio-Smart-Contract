...
export class EURC__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<EURC>;
  }
  ...
  override attach(address: string): EURC {
    return super.attach(address) as EURC;
  }
  override connect(signer: Signer): EURC__factory {
    return super.connect(signer) as EURC__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EURCInterface {
    return new utils.Interface(_abi) as EURCInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EURC {
    return new Contract(address, _abi, signerOrProvider) as EURC;
  }
}
