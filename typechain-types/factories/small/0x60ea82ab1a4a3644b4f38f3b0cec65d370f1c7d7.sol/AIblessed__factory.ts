...
export class AIblessed__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<AIblessed>;
  }
  ...
  override attach(address: string): AIblessed {
    return super.attach(address) as AIblessed;
  }
  override connect(signer: Signer): AIblessed__factory {
    return super.connect(signer) as AIblessed__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AIblessedInterface {
    return new utils.Interface(_abi) as AIblessedInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AIblessed {
    return new Contract(address, _abi, signerOrProvider) as AIblessed;
  }
}
