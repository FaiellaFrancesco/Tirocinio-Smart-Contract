...
export interface PEPSLAMInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface PEPSLAM extends BaseContract {
  connect(runner?: ContractRunner | null): PEPSLAM;
  waitForDeployment(): Promise<this>;

  interface: PEPSLAMInterface;
