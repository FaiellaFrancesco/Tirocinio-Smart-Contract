...
export interface USPEPEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface USPEPE extends BaseContract {
  connect(runner?: ContractRunner | null): USPEPE;
  waitForDeployment(): Promise<this>;

  interface: USPEPEInterface;
