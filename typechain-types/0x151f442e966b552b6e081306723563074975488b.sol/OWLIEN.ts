...
export interface OWLIENInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface OWLIEN extends BaseContract {
  connect(runner?: ContractRunner | null): OWLIEN;
  waitForDeployment(): Promise<this>;

  interface: OWLIENInterface;
