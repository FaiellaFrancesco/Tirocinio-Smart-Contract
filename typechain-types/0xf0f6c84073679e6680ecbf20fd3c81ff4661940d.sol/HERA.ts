...
export interface HERAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface HERA extends BaseContract {
  connect(runner?: ContractRunner | null): HERA;
  waitForDeployment(): Promise<this>;

  interface: HERAInterface;
