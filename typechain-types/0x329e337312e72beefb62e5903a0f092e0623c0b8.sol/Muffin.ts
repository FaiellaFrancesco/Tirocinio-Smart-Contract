...
export interface MuffinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Muffin extends BaseContract {
  connect(runner?: ContractRunner | null): Muffin;
  waitForDeployment(): Promise<this>;

  interface: MuffinInterface;
