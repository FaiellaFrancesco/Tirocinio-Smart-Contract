...
export interface KraftKatInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface KraftKat extends BaseContract {
  connect(runner?: ContractRunner | null): KraftKat;
  waitForDeployment(): Promise<this>;

  interface: KraftKatInterface;
