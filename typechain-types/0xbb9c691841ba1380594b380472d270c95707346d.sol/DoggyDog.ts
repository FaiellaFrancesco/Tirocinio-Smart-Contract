...
export interface DoggyDogInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface DoggyDog extends BaseContract {
  connect(runner?: ContractRunner | null): DoggyDog;
  waitForDeployment(): Promise<this>;

  interface: DoggyDogInterface;
