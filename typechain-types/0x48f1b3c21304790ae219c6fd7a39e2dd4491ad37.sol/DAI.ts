...
export interface DAI extends BaseContract {
  ...
  _maxDAITaxSwap: TypedContractMethod<[], [bigint], "view">;
  ...
  rescueDAITOKNETH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "_maxDAITaxSwap"
  ...
  getFunction(
    nameOrSignature: "rescueDAITOKNETH"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
