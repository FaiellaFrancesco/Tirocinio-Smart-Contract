...
export interface ContractNewInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ContractNew extends BaseContract {
  connect(runner?: ContractRunner | null): ContractNew;
  waitForDeployment(): Promise<this>;

  interface: ContractNewInterface;
