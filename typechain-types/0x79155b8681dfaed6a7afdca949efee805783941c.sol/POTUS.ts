...
export interface POTUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface POTUS extends BaseContract {
  connect(runner?: ContractRunner | null): POTUS;
  waitForDeployment(): Promise<this>;

  interface: POTUSInterface;
