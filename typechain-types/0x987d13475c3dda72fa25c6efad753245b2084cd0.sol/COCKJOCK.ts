...
export interface COCKJOCKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface COCKJOCK extends BaseContract {
  connect(runner?: ContractRunner | null): COCKJOCK;
  waitForDeployment(): Promise<this>;

  interface: COCKJOCKInterface;
