...
export interface TRUMPIUSAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface TRUMPIUSA extends BaseContract {
  connect(runner?: ContractRunner | null): TRUMPIUSA;
  waitForDeployment(): Promise<this>;

  interface: TRUMPIUSAInterface;
