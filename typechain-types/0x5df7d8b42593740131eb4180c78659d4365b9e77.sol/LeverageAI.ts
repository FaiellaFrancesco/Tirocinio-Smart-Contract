...
export interface LeverageAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "OpenTrade"
      | "allowance"
...
export interface LeverageAI extends BaseContract {
  connect(runner?: ContractRunner | null): LeverageAI;
  waitForDeployment(): Promise<this>;

  interface: LeverageAIInterface;
