...
export interface MAXIMUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface MAXIMUS extends BaseContract {
  connect(runner?: ContractRunner | null): MAXIMUS;
  waitForDeployment(): Promise<this>;

  interface: MAXIMUSInterface;
