...
export interface CreeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Cree extends BaseContract {
  connect(runner?: ContractRunner | null): Cree;
  waitForDeployment(): Promise<this>;

  interface: CreeInterface;
