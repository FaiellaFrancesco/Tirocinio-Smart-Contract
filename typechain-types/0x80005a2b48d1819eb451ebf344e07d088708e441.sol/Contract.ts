...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot36", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot36: TypedContractMethod<[a: AddressLike], [boolean], "view">;
