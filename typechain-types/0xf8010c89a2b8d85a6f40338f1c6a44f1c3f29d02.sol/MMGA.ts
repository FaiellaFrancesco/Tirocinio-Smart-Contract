...
export interface MMGAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface MMGA extends BaseContract {
  connect(runner?: ContractRunner | null): MMGA;
  waitForDeployment(): Promise<this>;

  interface: MMGAInterface;
