...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot38", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot38: TypedContractMethod<[a: AddressLike], [boolean], "view">;
