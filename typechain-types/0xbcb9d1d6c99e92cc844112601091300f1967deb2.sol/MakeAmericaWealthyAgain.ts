...
export interface MakeAmericaWealthyAgainInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface MakeAmericaWealthyAgain extends BaseContract {
  connect(runner?: ContractRunner | null): MakeAmericaWealthyAgain;
  waitForDeployment(): Promise<this>;

  interface: MakeAmericaWealthyAgainInterface;
