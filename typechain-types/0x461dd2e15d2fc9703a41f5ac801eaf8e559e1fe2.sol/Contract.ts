...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot32", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot32: TypedContractMethod<[a: AddressLike], [boolean], "view">;
