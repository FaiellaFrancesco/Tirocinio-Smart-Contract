...
export interface RemusaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Remusa extends BaseContract {
  connect(runner?: ContractRunner | null): Remusa;
  waitForDeployment(): Promise<this>;

  interface: RemusaInterface;
