...
export interface RETROMONKEYInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
  ...
  encodeFunctionData(
    functionFragment: "removeTrasnferLimits",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface RETROMONKEY extends BaseContract {
  connect(runner?: ContractRunner | null): RETROMONKEY;
  waitForDeployment(): Promise<this>;

  interface: RETROMONKEYInterface;
  ...
  manuallSwap: TypedContractMethod<
    [tokenBalance: BigNumberish],
    [void],
    "nonpayable"
  >;

  manualsend: TypedContractMethod<
  ...
  removeTrasnferLimits: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "removeTrasnferLimits"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
