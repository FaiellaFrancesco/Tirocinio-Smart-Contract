...
export interface LoopyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
  ...
  encodeFunctionData(
    functionFragment: "clearStuckERC20",
    values: [AddressLike, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "initiateCheck",
    values: [BytesLike]
  ): string;
...
export interface Loopy extends BaseContract {
  connect(runner?: ContractRunner | null): Loopy;
  waitForDeployment(): Promise<this>;

  interface: LoopyInterface;
  ...
  clearStuckERC20: TypedContractMethod<
  ...
  initiateCheck: TypedContractMethod<[seed: BytesLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "clearStuckERC20"
  ): TypedContractMethod<
    [_address: AddressLike, percent: BigNumberish],
    [void],
    "nonpayable"
