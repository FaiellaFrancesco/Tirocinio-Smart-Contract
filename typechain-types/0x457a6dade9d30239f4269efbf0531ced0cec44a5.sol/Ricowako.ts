...
export interface RicowakoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Ricowako extends BaseContract {
  connect(runner?: ContractRunner | null): Ricowako;
  waitForDeployment(): Promise<this>;

  interface: RicowakoInterface;
