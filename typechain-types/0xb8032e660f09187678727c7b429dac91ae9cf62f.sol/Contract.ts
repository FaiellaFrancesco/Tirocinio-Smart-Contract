...
export interface ContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isBot40", data: BytesLike): Result;
...
export interface Contract extends BaseContract {
  ...
  isBot40: TypedContractMethod<[a: AddressLike], [boolean], "view">;
