...
export interface AIBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface AIB extends BaseContract {
  connect(runner?: ContractRunner | null): AIB;
  waitForDeployment(): Promise<this>;

  interface: AIBInterface;
  ...
  openTrading: TypedContractMethod<
