...
export interface MAGAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface MAGA extends BaseContract {
  connect(runner?: ContractRunner | null): MAGA;
  waitForDeployment(): Promise<this>;

  interface: MAGAInterface;
