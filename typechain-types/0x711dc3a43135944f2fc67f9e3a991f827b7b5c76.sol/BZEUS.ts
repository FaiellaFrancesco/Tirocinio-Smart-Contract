...
export interface BZEUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface BZEUS extends BaseContract {
  connect(runner?: ContractRunner | null): BZEUS;
  waitForDeployment(): Promise<this>;

  interface: BZEUSInterface;
