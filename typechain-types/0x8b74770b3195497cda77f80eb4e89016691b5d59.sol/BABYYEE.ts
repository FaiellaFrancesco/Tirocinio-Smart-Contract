...
export interface BABYYEEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface BABYYEE extends BaseContract {
  connect(runner?: ContractRunner | null): BABYYEE;
  waitForDeployment(): Promise<this>;

  interface: BABYYEEInterface;
