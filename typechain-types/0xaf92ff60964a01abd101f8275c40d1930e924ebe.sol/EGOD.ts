...
export interface EGODInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface EGOD extends BaseContract {
  connect(runner?: ContractRunner | null): EGOD;
  waitForDeployment(): Promise<this>;

  interface: EGODInterface;
