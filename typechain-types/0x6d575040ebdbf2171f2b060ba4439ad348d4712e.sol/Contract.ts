...
export interface ContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "renounceOwnership"
      | "rescueERC20"
      | "setSwapTreshold_11Xxx789876srfsd"
      | "symbol"
      | "totalSupply"
      | "transfer"
      | "transferFrom"
  ...
  encodeFunctionData(
    functionFragment: "setSwapTreshold_11Xxx789876srfsd",
    values: [BigNumberish]
  ): string;
...
export interface Contract extends BaseContract {
  ...
  setSwapTreshold_11Xxx789876srfsd: TypedContractMethod<
    [_new: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setSwapTreshold_11Xxx789876srfsd"
