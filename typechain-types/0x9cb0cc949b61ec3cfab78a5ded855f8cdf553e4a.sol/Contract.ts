...
export interface ContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "renounceOwnership"
      | "rescueERC20"
      | "setSwapTreshold_110879879ccxyfvxyf9554"
      | "symbol"
      | "totalSupply"
      | "transfer"
      | "transferFrom"
  ...
  encodeFunctionData(
    functionFragment: "setSwapTreshold_110879879ccxyfvxyf9554",
    values: [BigNumberish]
  ): string;
...
export interface Contract extends BaseContract {
  ...
  setSwapTreshold_110879879ccxyfvxyf9554: TypedContractMethod<
    [_new: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setSwapTreshold_110879879ccxyfvxyf9554"
