...
export interface LeonardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_bots"
      | "_maxTaxSwap"
...
export interface Leonard extends BaseContract {
  connect(runner?: ContractRunner | null): Leonard;
  waitForDeployment(): Promise<this>;

  interface: LeonardInterface;
