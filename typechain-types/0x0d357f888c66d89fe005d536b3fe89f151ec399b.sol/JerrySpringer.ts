...
export interface JerrySpringerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface JerrySpringer extends BaseContract {
  connect(runner?: ContractRunner | null): JerrySpringer;
  waitForDeployment(): Promise<this>;

  interface: JerrySpringerInterface;
