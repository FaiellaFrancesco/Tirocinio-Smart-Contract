...
export interface POPEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface POPE extends BaseContract {
  connect(runner?: ContractRunner | null): POPE;
  waitForDeployment(): Promise<this>;

  interface: POPEInterface;
