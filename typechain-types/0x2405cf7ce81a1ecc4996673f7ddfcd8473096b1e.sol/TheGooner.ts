...
export interface TheGoonerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface TheGooner extends BaseContract {
  connect(runner?: ContractRunner | null): TheGooner;
  waitForDeployment(): Promise<this>;

  interface: TheGoonerInterface;
