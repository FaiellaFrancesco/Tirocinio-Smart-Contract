...
export interface TrumpMarsInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export namespace TrumpWalletUpdatedEvent {
...
export interface TrumpMars extends BaseContract {
  connect(runner?: ContractRunner | null): TrumpMars;
  ...
  updateTrumpWallet: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "updateTrumpWallet"
  ...
  >;
  getEvent(
    key: "TrumpWalletUpdated"
  ): TypedContractEvent<
    TrumpWalletUpdatedEvent.InputTuple,
    TrumpWalletUpdatedEvent.OutputTuple,
    TrumpWalletUpdatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "TrumpWalletUpdated(address,address)": TypedContractEvent<
      TrumpWalletUpdatedEvent.InputTuple,
      TrumpWalletUpdatedEvent.OutputTuple,
      TrumpWalletUpdatedEvent.OutputObject
    >;
    TrumpWalletUpdated: TypedContractEvent<
      TrumpWalletUpdatedEvent.InputTuple,
      TrumpWalletUpdatedEvent.OutputTuple,
      TrumpWalletUpdatedEvent.OutputObject
    >;
