...
export interface EpepInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Epep extends BaseContract {
  connect(runner?: ContractRunner | null): Epep;
  waitForDeployment(): Promise<this>;

  interface: EpepInterface;
