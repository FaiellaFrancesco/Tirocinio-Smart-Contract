...
export interface PPPPInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_buyCount"
      | "_finalBuyTax"
...
export interface PPPP extends BaseContract {
  connect(runner?: ContractRunner | null): PPPP;
  waitForDeployment(): Promise<this>;

  interface: PPPPInterface;
