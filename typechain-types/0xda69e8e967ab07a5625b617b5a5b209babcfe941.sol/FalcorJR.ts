...
export interface FalcorJRInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface FalcorJR extends BaseContract {
  connect(runner?: ContractRunner | null): FalcorJR;
  waitForDeployment(): Promise<this>;

  interface: FalcorJRInterface;
