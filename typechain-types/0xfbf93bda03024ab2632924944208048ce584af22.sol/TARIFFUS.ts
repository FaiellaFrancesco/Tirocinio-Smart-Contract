...
export interface TARIFFUSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface TARIFFUS extends BaseContract {
  connect(runner?: ContractRunner | null): TARIFFUS;
  waitForDeployment(): Promise<this>;

  interface: TARIFFUSInterface;
