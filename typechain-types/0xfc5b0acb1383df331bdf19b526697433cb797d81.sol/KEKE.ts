...
export interface KEKEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface KEKE extends BaseContract {
  connect(runner?: ContractRunner | null): KEKE;
  waitForDeployment(): Promise<this>;

  interface: KEKEInterface;
