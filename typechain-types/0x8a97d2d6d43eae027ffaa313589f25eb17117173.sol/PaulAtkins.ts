...
export interface PaulAtkinsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface PaulAtkins extends BaseContract {
  connect(runner?: ContractRunner | null): PaulAtkins;
  waitForDeployment(): Promise<this>;

  interface: PaulAtkinsInterface;
