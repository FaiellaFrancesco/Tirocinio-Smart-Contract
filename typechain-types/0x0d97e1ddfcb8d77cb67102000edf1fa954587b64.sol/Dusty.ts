...
export interface DustyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Dusty extends BaseContract {
  connect(runner?: ContractRunner | null): Dusty;
  waitForDeployment(): Promise<this>;

  interface: DustyInterface;
