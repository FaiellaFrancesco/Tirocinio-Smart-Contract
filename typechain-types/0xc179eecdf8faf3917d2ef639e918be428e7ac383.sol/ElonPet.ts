...
export interface ElonPetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface ElonPet extends BaseContract {
  connect(runner?: ContractRunner | null): ElonPet;
  waitForDeployment(): Promise<this>;

  interface: ElonPetInterface;
