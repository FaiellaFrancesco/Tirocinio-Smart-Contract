...
export interface SuichanInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface Suichan extends BaseContract {
  connect(runner?: ContractRunner | null): Suichan;
  waitForDeployment(): Promise<this>;

  interface: SuichanInterface;
