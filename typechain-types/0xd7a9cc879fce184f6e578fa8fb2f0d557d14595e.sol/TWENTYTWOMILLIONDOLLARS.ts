...
export interface TWENTYTWOMILLIONDOLLARSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface TWENTYTWOMILLIONDOLLARS extends BaseContract {
  connect(runner?: ContractRunner | null): TWENTYTWOMILLIONDOLLARS;
  waitForDeployment(): Promise<this>;

  interface: TWENTYTWOMILLIONDOLLARSInterface;
