...
export interface CheeseRemusInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_maxTaxSwap"
      | "_maxTxAmount"
...
export interface CheeseRemus extends BaseContract {
  connect(runner?: ContractRunner | null): CheeseRemus;
  waitForDeployment(): Promise<this>;

  interface: CheeseRemusInterface;
