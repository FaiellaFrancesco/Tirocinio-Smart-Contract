...
export interface ContractInterface extends utils.Interface {
  functions: {
    ...
    "openTradingPairCreatedAlready(address)": FunctionFragment;
    "owner()": FunctionFragment;
    "reduceFee(uint256)": FunctionFragment;
    "removeLimits55ihv89098f5chfii79mmkjj654(bool)": FunctionFragment;
    "removeTransferTax()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "rescueERC20(address,uint256)": FunctionFragment;
    "setSwapTreshold5575799809844908955h55555435(uint256)": FunctionFragment;
...
export interface Contract extends BaseContract {
  ...
  functions: {
    ...
    openTradingPairCreatedAlready(
      existingPair: PromiseOrValue<string>,
