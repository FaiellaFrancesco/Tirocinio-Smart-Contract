...
export interface TrumpMarsInterface extends utils.Interface {
  functions: {
    ...
    "updateTrumpWallet(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateTrumpWallet",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TrumpWalletUpdated(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TrumpWalletUpdated"): EventFragment;
...
export interface TrumpWalletUpdatedEventObject {
  newWallet: string;
  oldWallet: string;
}
export type TrumpWalletUpdatedEvent = TypedEvent<
  [string, string],
  TrumpWalletUpdatedEventObject
>;

export type TrumpWalletUpdatedEventFilter =
  TypedEventFilter<TrumpWalletUpdatedEvent>;
...
export interface TrumpMars extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TrumpMarsInterface;
