...
export interface TOKEN extends BaseContract {
  ...
  launchBGBVGH: TypedContractMethod<[], [void], "nonpayable">;
  ...
  rescueETHFROMGVV: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "rescueETHFROMGVV"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
