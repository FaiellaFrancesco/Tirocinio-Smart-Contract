 ...
 * ARTIFACT_SOURCE: contracts/0x3cd40aa0b961db03ce163c883891707735577d0b.sol
 * ARTIFACT_PATH: 0x3cd40aa0b961db03ce163c883891707735577d0b.sol/denovalabs.json
 * ARTIFACT_FQN: contracts/0x3cd40aa0b961db03ce163c883891707735577d0b.sol:denovalabs
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
 ...
 *   clearcontract()->nonpayable
 *   decimals()->pure
 *   name()->pure
 *   openlimiter()->nonpayable
 *   owner()->view
...
describe("denovalabs — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x3cd40aa0b961db03ce163c883891707735577d0b.sol:denovalabs");
