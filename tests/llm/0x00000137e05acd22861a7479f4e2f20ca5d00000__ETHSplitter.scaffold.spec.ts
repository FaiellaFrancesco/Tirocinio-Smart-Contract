...
/**
 * Auto-generated scaffold for ETHSplitter.
 * ARTIFACT_SOURCE: contracts/0x00000137e05acd22861a7479f4e2f20ca5d00000.sol
 * ARTIFACT_PATH: 0x00000137e05acd22861a7479f4e2f20ca5d00000.sol/ETHSplitter.json
 * ARTIFACT_FQN: contracts/0x00000137e05acd22861a7479f4e2f20ca5d00000.sol:ETHSplitter
 *
 * FUNCTIONS:
 *   claim(uint256)->payable
 *   splitETH(address[],uint256[])->nonpayable
 *
 * EVENTS:
...
describe("ETHSplitter — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x00000137e05acd22861a7479f4e2f20ca5d00000.sol:ETHSplitter");
