 ...
 * ARTIFACT_SOURCE: contracts/0x7c19fa48764d5e2f65fde701b1e4c92ea17837a3.sol
 * ARTIFACT_PATH: 0x7c19fa48764d5e2f65fde701b1e4c92ea17837a3.sol/COPE.json
 * ARTIFACT_FQN: contracts/0x7c19fa48764d5e2f65fde701b1e4c92ea17837a3.sol:COPE
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("COPE — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x7c19fa48764d5e2f65fde701b1e4c92ea17837a3.sol:COPE");
