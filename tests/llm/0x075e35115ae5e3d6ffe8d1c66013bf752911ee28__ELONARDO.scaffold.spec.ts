 ...
 * ARTIFACT_SOURCE: contracts/0x075e35115ae5e3d6ffe8d1c66013bf752911ee28.sol
 * ARTIFACT_PATH: 0x075e35115ae5e3d6ffe8d1c66013bf752911ee28.sol/ELONARDO.json
 * ARTIFACT_FQN: contracts/0x075e35115ae5e3d6ffe8d1c66013bf752911ee28.sol:ELONARDO
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("ELONARDO — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x075e35115ae5e3d6ffe8d1c66013bf752911ee28.sol:ELONARDO");
