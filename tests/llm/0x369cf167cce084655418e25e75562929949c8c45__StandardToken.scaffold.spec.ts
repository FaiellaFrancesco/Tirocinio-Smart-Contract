...
/**
 * Auto-generated scaffold for StandardToken.
 * ARTIFACT_SOURCE: contracts/0x369cf167cce084655418e25e75562929949c8c45.sol
 * ARTIFACT_PATH: 0x369cf167cce084655418e25e75562929949c8c45.sol/StandardToken.json
 * ARTIFACT_FQN: contracts/0x369cf167cce084655418e25e75562929949c8c45.sol:StandardToken
 *
 * FUNCTIONS:
 *   VERSION()->view
...
describe("StandardToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x369cf167cce084655418e25e75562929949c8c45.sol:StandardToken");
    const contract = await Contract.deploy("", "", BigInt(0), BigInt(0), ethers.ZeroAddress, BigInt(0));
