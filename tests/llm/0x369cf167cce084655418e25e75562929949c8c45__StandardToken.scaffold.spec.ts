...
import { StandardToken, StandardToken__factory } from "../../typechain-types";
...
describe("StandardToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const factory = new StandardToken__factory(owner);
    const contract = await factory.deploy("", "", 0n, 0n, ethers.ZeroAddress, 0n);
  ...
  describe("VERSION()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call VERSION() with valid inputs
