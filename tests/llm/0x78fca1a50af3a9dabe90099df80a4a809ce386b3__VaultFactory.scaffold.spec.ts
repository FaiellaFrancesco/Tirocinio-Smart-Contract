...
/**
 * Auto-generated scaffold for VaultFactory.
 * ARTIFACT_SOURCE: contracts/0x78fca1a50af3a9dabe90099df80a4a809ce386b3.sol
 * ARTIFACT_PATH: 0x78fca1a50af3a9dabe90099df80a4a809ce386b3.sol/VaultFactory.json
 * ARTIFACT_FQN: contracts/0x78fca1a50af3a9dabe90099df80a4a809ce386b3.sol:VaultFactory
 *
 * FUNCTIONS:
 *   createVault(address,address,address)->nonpayable
 *
 * EVENTS:
...
describe("VaultFactory — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x78fca1a50af3a9dabe90099df80a4a809ce386b3.sol:VaultFactory");
