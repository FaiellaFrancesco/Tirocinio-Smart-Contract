...
/**
 * Auto-generated scaffold for SlingshotSLINGToken.
 * ARTIFACT_SOURCE: contracts/0xcfc70aa5231397aa20e3f1bdf7e434ea1e41c01d.sol
 * ARTIFACT_PATH: 0xcfc70aa5231397aa20e3f1bdf7e434ea1e41c01d.sol/SlingshotSLINGToken.json
 * ARTIFACT_FQN: contracts/0xcfc70aa5231397aa20e3f1bdf7e434ea1e41c01d.sol:SlingshotSLINGToken
 *
 * FUNCTIONS:
 *   SlingshotSLINGVC()->view
...
describe("SlingshotSLINGToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xcfc70aa5231397aa20e3f1bdf7e434ea1e41c01d.sol:SlingshotSLINGToken");
    const contract = await Contract.deploy("", "", BigInt(0), BigInt(0), ethers.ZeroAddress, ethers.ZeroAddress);
  ...
  describe("SlingshotSLINGVC()", function () {
    it("happy path", async function () {
      // TODO_AI: Replace this entire comment block with working test code
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // TODO_AI: Call SlingshotSLINGVC() and add assertions
  ...
  describe("getSlingshotSLINGVC()", function () {
    it("happy path", async function () {
      // TODO_AI: Replace this entire comment block with working test code
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // TODO_AI: Call getSlingshotSLINGVC() and add assertions
      this.skip(); // TODO_AI: remove this line when implementing
    });
