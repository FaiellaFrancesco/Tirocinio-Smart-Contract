...
import { SlingshotSLINGToken, SlingshotSLINGToken__factory } from "../../typechain-types";
...
describe("SlingshotSLINGToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const factory = new SlingshotSLINGToken__factory(owner);
  ...
  describe("SlingshotSLINGVC()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call SlingshotSLINGVC() with valid inputs
  ...
  describe("getSlingshotSLINGVC()", function () {
    it("happy path", async function () {
      this.skip(); // TODO_AI: remove this.skip() when implementing
      // TODO_AI: Arrange -> prepare preconditions if needed
      // TODO_AI: Act -> call getSlingshotSLINGVC() with valid inputs
      // TODO_AI: Assert -> expect correct return values
    });
