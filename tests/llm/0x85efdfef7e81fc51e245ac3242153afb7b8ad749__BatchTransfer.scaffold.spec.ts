 ...
 * ARTIFACT_SOURCE: contracts/0x85efdfef7e81fc51e245ac3242153afb7b8ad749.sol
 * ARTIFACT_PATH: 0x85efdfef7e81fc51e245ac3242153afb7b8ad749.sol/BatchTransfer.json
 * ARTIFACT_FQN: contracts/0x85efdfef7e81fc51e245ac3242153afb7b8ad749.sol:BatchTransfer
 *
 * FUNCTIONS:
 *   batchTransferETH(address[],uint256[])->payable
 *   batchTransferTokenByTransferFrom(address,address[],uint256[])->nonpayable
 *   owner()->view
...
describe("BatchTransfer — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x85efdfef7e81fc51e245ac3242153afb7b8ad749.sol:BatchTransfer");
