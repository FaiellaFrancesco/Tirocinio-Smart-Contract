 ...
 * ARTIFACT_SOURCE: contracts/0x3aa8f9cbc8a5a16c1a4b09d8cab51fe0378abffd.sol
 * ARTIFACT_PATH: 0x3aa8f9cbc8a5a16c1a4b09d8cab51fe0378abffd.sol/TRUST.json
 * ARTIFACT_FQN: contracts/0x3aa8f9cbc8a5a16c1a4b09d8cab51fe0378abffd.sol:TRUST
 *
 * FUNCTIONS:
 *   _buyCount()->view
 *   _finalBuyTax()->view
...
describe("TRUST — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x3aa8f9cbc8a5a16c1a4b09d8cab51fe0378abffd.sol:TRUST");
