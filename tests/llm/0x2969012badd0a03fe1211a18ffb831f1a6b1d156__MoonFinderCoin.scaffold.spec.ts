 ...
 * ARTIFACT_SOURCE: contracts/0x2969012badd0a03fe1211a18ffb831f1a6b1d156.sol
 * ARTIFACT_PATH: 0x2969012badd0a03fe1211a18ffb831f1a6b1d156.sol/MoonFinderCoin.json
 * ARTIFACT_FQN: contracts/0x2969012badd0a03fe1211a18ffb831f1a6b1d156.sol:MoonFinderCoin
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("MoonFinderCoin — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x2969012badd0a03fe1211a18ffb831f1a6b1d156.sol:MoonFinderCoin");
