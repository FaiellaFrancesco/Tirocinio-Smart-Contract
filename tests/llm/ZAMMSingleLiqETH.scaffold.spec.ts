...
/**
 * Scaffold generato automaticamente per ZAMMSingleLiqETH.
...
describe("ZAMMSingleLiqETH — LLM Scaffold", function () {
  ...
  describe("addSingleLiqETH(tuple,uint256,uint256,uint256,address,uint256)", function () {
    ...
    it("reverts su input/ruolo non valido", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.addSingleLiqETH(/* TODO_AI bad */, /* TODO_AI bad */, /* TODO_AI bad */, /* TODO_AI bad */, /* TODO_AI bad */, /* TODO_AI bad */)
