 ...
 * ARTIFACT_SOURCE: contracts/0xa21afd52d8ac6d5ff485100cd5fc104b89c125fc.sol
 * ARTIFACT_PATH: 0xa21afd52d8ac6d5ff485100cd5fc104b89c125fc.sol/RAJA.json
 * ARTIFACT_FQN: contracts/0xa21afd52d8ac6d5ff485100cd5fc104b89c125fc.sol:RAJA
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("RAJA — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xa21afd52d8ac6d5ff485100cd5fc104b89c125fc.sol:RAJA");
