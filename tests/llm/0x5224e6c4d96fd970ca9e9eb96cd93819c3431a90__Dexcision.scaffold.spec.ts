 ...
 * ARTIFACT_SOURCE: contracts/0x5224e6c4d96fd970ca9e9eb96cd93819c3431a90.sol
 * ARTIFACT_PATH: 0x5224e6c4d96fd970ca9e9eb96cd93819c3431a90.sol/Dexcision.json
 * ARTIFACT_FQN: contracts/0x5224e6c4d96fd970ca9e9eb96cd93819c3431a90.sol:Dexcision
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("Dexcision — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x5224e6c4d96fd970ca9e9eb96cd93819c3431a90.sol:Dexcision");
