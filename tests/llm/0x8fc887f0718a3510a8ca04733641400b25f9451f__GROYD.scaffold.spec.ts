 ...
 * ARTIFACT_SOURCE: contracts/0x8fc887f0718a3510a8ca04733641400b25f9451f.sol
 * ARTIFACT_PATH: 0x8fc887f0718a3510a8ca04733641400b25f9451f.sol/GROYD.json
 * ARTIFACT_FQN: contracts/0x8fc887f0718a3510a8ca04733641400b25f9451f.sol:GROYD
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("GROYD — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x8fc887f0718a3510a8ca04733641400b25f9451f.sol:GROYD");
