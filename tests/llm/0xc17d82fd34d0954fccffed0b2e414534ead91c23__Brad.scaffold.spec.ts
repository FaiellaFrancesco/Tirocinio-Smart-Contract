 ...
 * ARTIFACT_SOURCE: contracts/0xc17d82fd34d0954fccffed0b2e414534ead91c23.sol
 * ARTIFACT_PATH: 0xc17d82fd34d0954fccffed0b2e414534ead91c23.sol/Brad.json
 * ARTIFACT_FQN: contracts/0xc17d82fd34d0954fccffed0b2e414534ead91c23.sol:Brad
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("Brad — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xc17d82fd34d0954fccffed0b2e414534ead91c23.sol:Brad");
