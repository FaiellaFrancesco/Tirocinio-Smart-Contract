...
/**
 * Auto-generated scaffold for ZEUS.
 * ARTIFACT_SOURCE: contracts/0x27e4202bf7d1ad2b871bdf07a8444750a1dddb75.sol
 * ARTIFACT_PATH: 0x27e4202bf7d1ad2b871bdf07a8444750a1dddb75.sol/ZEUS.json
 * ARTIFACT_FQN: contracts/0x27e4202bf7d1ad2b871bdf07a8444750a1dddb75.sol:ZEUS
 *
 * FUNCTIONS:
 *   _maxZEUSTaxSwap()->view
...
describe("ZEUS — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x27e4202bf7d1ad2b871bdf07a8444750a1dddb75.sol:ZEUS");
  ...
  describe("_maxZEUSTaxSwap()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call _maxZEUSTaxSwap() with valid inputs
