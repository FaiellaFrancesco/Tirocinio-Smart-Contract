 ...
 * ARTIFACT_SOURCE: contracts/0x6ba48355d17cb6c8d4d325984167184f71f7bda8.sol
 * ARTIFACT_PATH: 0x6ba48355d17cb6c8d4d325984167184f71f7bda8.sol/MAXIMUS.json
 * ARTIFACT_FQN: contracts/0x6ba48355d17cb6c8d4d325984167184f71f7bda8.sol:MAXIMUS
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("MAXIMUS — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x6ba48355d17cb6c8d4d325984167184f71f7bda8.sol:MAXIMUS");
