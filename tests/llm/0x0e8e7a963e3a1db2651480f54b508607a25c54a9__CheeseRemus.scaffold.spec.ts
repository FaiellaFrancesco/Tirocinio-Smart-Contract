 ...
 * ARTIFACT_SOURCE: contracts/0x0e8e7a963e3a1db2651480f54b508607a25c54a9.sol
 * ARTIFACT_PATH: 0x0e8e7a963e3a1db2651480f54b508607a25c54a9.sol/CheeseRemus.json
 * ARTIFACT_FQN: contracts/0x0e8e7a963e3a1db2651480f54b508607a25c54a9.sol:CheeseRemus
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("CheeseRemus — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x0e8e7a963e3a1db2651480f54b508607a25c54a9.sol:CheeseRemus");
