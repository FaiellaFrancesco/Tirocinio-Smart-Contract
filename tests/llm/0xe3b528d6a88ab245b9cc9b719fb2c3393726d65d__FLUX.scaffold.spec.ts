 ...
 * ARTIFACT_SOURCE: contracts/0xe3b528d6a88ab245b9cc9b719fb2c3393726d65d.sol
 * ARTIFACT_PATH: 0xe3b528d6a88ab245b9cc9b719fb2c3393726d65d.sol/FLUX.json
 * ARTIFACT_FQN: contracts/0xe3b528d6a88ab245b9cc9b719fb2c3393726d65d.sol:FLUX
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("FLUX — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xe3b528d6a88ab245b9cc9b719fb2c3393726d65d.sol:FLUX");
