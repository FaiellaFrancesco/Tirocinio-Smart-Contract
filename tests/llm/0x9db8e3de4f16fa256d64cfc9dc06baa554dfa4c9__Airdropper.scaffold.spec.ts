 ...
 * ARTIFACT_PATH: 0x9db8e3de4f16fa256d64cfc9dc06baa554dfa4c9.sol/Airdropper.json
 * ARTIFACT_FQN: contracts/0x9db8e3de4f16fa256d64cfc9dc06baa554dfa4c9.sol:Airdropper
 *
 * FUNCTIONS:
 *   allow(address,uint256)->nonpayable
 *   owner()->view
 *
 * EVENTS:
 *   (none)
...
describe("Airdropper — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x9db8e3de4f16fa256d64cfc9dc06baa554dfa4c9.sol:Airdropper");
