 ...
 * ARTIFACT_PATH: 0x02857da49948fb3e33b66ca66825ff8fe5b0ede1.sol/Erc20.json
 * ARTIFACT_FQN: contracts/0x02857da49948fb3e33b66ca66825ff8fe5b0ede1.sol:Erc20
 *
 * FUNCTIONS:
...
describe("Erc20 — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x02857da49948fb3e33b66ca66825ff8fe5b0ede1.sol:Erc20");
