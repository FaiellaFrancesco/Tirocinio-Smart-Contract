 ...
 * ARTIFACT_SOURCE: contracts/0x841543feb1468d15d97764214de0dc8049ceeaba.sol
 * ARTIFACT_PATH: 0x841543feb1468d15d97764214de0dc8049ceeaba.sol/ContractNew.json
 * ARTIFACT_FQN: contracts/0x841543feb1468d15d97764214de0dc8049ceeaba.sol:ContractNew
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("ContractNew — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x841543feb1468d15d97764214de0dc8049ceeaba.sol:ContractNew");
