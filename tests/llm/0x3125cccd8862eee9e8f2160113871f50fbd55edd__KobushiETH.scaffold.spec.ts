 ...
 * ARTIFACT_SOURCE: contracts/0x3125cccd8862eee9e8f2160113871f50fbd55edd.sol
 * ARTIFACT_PATH: 0x3125cccd8862eee9e8f2160113871f50fbd55edd.sol/KobushiETH.json
 * ARTIFACT_FQN: contracts/0x3125cccd8862eee9e8f2160113871f50fbd55edd.sol:KobushiETH
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("KobushiETH — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x3125cccd8862eee9e8f2160113871f50fbd55edd.sol:KobushiETH");
