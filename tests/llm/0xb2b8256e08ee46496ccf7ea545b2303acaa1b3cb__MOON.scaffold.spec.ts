 ...
 * ARTIFACT_SOURCE: contracts/0xb2b8256e08ee46496ccf7ea545b2303acaa1b3cb.sol
 * ARTIFACT_PATH: 0xb2b8256e08ee46496ccf7ea545b2303acaa1b3cb.sol/MOON.json
 * ARTIFACT_FQN: contracts/0xb2b8256e08ee46496ccf7ea545b2303acaa1b3cb.sol:MOON
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("MOON — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xb2b8256e08ee46496ccf7ea545b2303acaa1b3cb.sol:MOON");
