 ...
 * ARTIFACT_SOURCE: contracts/0x4fcba1fad3e4202f612adde9ceb106591a341333.sol
 * ARTIFACT_PATH: 0x4fcba1fad3e4202f612adde9ceb106591a341333.sol/PAOPAO.json
 * ARTIFACT_FQN: contracts/0x4fcba1fad3e4202f612adde9ceb106591a341333.sol:PAOPAO
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("PAOPAO — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x4fcba1fad3e4202f612adde9ceb106591a341333.sol:PAOPAO");
