 ...
 * ARTIFACT_SOURCE: contracts/0x783709dc72486e2cf74ee3ee3766a3e4db082e26.sol
 * ARTIFACT_PATH: 0x783709dc72486e2cf74ee3ee3766a3e4db082e26.sol/cree.json
 * ARTIFACT_FQN: contracts/0x783709dc72486e2cf74ee3ee3766a3e4db082e26.sol:cree
 *
 * FUNCTIONS:
 *   _bots(address)->view
 *   _maxTaxSwap()->view
...
describe("cree — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x783709dc72486e2cf74ee3ee3766a3e4db082e26.sol:cree");
