 ...
 * ARTIFACT_SOURCE: contracts/0x57392bf757639c45492866f4e24d92fd963feae9.sol
 * ARTIFACT_PATH: 0x57392bf757639c45492866f4e24d92fd963feae9.sol/BabyPepe.json
 * ARTIFACT_FQN: contracts/0x57392bf757639c45492866f4e24d92fd963feae9.sol:BabyPepe
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("BabyPepe — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x57392bf757639c45492866f4e24d92fd963feae9.sol:BabyPepe");
