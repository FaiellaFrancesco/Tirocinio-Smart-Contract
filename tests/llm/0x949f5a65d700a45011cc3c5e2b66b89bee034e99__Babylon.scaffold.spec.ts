...
/**
 * Auto-generated scaffold for Babylon.
 * ARTIFACT_SOURCE: contracts/0x949f5a65d700a45011cc3c5e2b66b89bee034e99.sol
 * ARTIFACT_PATH: 0x949f5a65d700a45011cc3c5e2b66b89bee034e99.sol/Babylon.json
 * ARTIFACT_FQN: contracts/0x949f5a65d700a45011cc3c5e2b66b89bee034e99.sol:Babylon
 *
 * FUNCTIONS:
 *   allowance(address,address)->view
 *   approve(address,uint256)->nonpayable
 *   balanceOf(address)->view
 *   bulktransfer(address[],uint256)->nonpayable
 *   decimals()->view
 *   name()->view
 *   symbol()->view
 *   totalSupply()->view
...
describe("Babylon — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x949f5a65d700a45011cc3c5e2b66b89bee034e99.sol:Babylon");
  ...
  describe("bulktransfer(address[],uint256)", function () {
    it("happy path", async function () {
      this.skip(); // TODO_AI: remove this.skip() when implementing
      // TODO_AI: Arrange -> prepare preconditions (e.g., fund contract if withdrawing)
      // TODO_AI: Act -> call the function with valid inputs
