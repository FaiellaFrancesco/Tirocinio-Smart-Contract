...
import { TokenMintERC20Token, TokenMintERC20Token__factory } from "../../typechain-types";

/**
 * Auto-generated scaffold for TokenMintERC20Token.
 * ARTIFACT_SOURCE: contracts/0x4494b256908654709e35c1d16a15363bf9d4648b.sol
 * ARTIFACT_PATH: 0x4494b256908654709e35c1d16a15363bf9d4648b.sol/TokenMintERC20Token.json
 * ARTIFACT_FQN: contracts/0x4494b256908654709e35c1d16a15363bf9d4648b.sol:TokenMintERC20Token
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("TokenMintERC20Token — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const factory = new TokenMintERC20Token__factory(owner);
