 ...
 * ARTIFACT_SOURCE: contracts/0x457a6dade9d30239f4269efbf0531ced0cec44a5.sol
 * ARTIFACT_PATH: 0x457a6dade9d30239f4269efbf0531ced0cec44a5.sol/ricowako.json
 * ARTIFACT_FQN: contracts/0x457a6dade9d30239f4269efbf0531ced0cec44a5.sol:ricowako
 *
 * FUNCTIONS:
 *   _bots(address)->view
 *   _maxTaxSwap()->view
...
describe("ricowako — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x457a6dade9d30239f4269efbf0531ced0cec44a5.sol:ricowako");
