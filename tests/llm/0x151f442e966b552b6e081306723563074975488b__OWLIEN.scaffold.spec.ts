 ...
 * ARTIFACT_SOURCE: contracts/0x151f442e966b552b6e081306723563074975488b.sol
 * ARTIFACT_PATH: 0x151f442e966b552b6e081306723563074975488b.sol/OWLIEN.json
 * ARTIFACT_FQN: contracts/0x151f442e966b552b6e081306723563074975488b.sol:OWLIEN
 *
 * FUNCTIONS:
 *   _buyCount()->view
 *   _finalBuyTax()->view
...
describe("OWLIEN — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x151f442e966b552b6e081306723563074975488b.sol:OWLIEN");
