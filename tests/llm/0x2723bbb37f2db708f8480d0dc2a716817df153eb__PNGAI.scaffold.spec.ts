...
/**
 * Auto-generated scaffold for PNGAI.
 * ARTIFACT_SOURCE: contracts/0x2723bbb37f2db708f8480d0dc2a716817df153eb.sol
 * ARTIFACT_PATH: 0x2723bbb37f2db708f8480d0dc2a716817df153eb.sol/PNGAI.json
 * ARTIFACT_FQN: contracts/0x2723bbb37f2db708f8480d0dc2a716817df153eb.sol:PNGAI
 *
 * FUNCTIONS:
...
describe("PNGAI — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x2723bbb37f2db708f8480d0dc2a716817df153eb.sol:PNGAI");
