 ...
 * ARTIFACT_SOURCE: contracts/0x8bbc464a3fcbc26ce4b62cc5edf2f8a6ca836ea1.sol
 * ARTIFACT_PATH: 0x8bbc464a3fcbc26ce4b62cc5edf2f8a6ca836ea1.sol/CMAXIMUS.json
 * ARTIFACT_FQN: contracts/0x8bbc464a3fcbc26ce4b62cc5edf2f8a6ca836ea1.sol:CMAXIMUS
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
 ...
 *   setFeeWallet(address)->nonpayable
 *   symbol()->pure
 *   totalSupply()->pure
...
describe("CMAXIMUS — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x8bbc464a3fcbc26ce4b62cc5edf2f8a6ca836ea1.sol:CMAXIMUS");
