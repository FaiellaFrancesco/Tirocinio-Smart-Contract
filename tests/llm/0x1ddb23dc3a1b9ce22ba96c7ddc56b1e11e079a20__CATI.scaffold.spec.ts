 ...
 * ARTIFACT_SOURCE: contracts/0x1ddb23dc3a1b9ce22ba96c7ddc56b1e11e079a20.sol
 * ARTIFACT_PATH: 0x1ddb23dc3a1b9ce22ba96c7ddc56b1e11e079a20.sol/CATI.json
 * ARTIFACT_FQN: contracts/0x1ddb23dc3a1b9ce22ba96c7ddc56b1e11e079a20.sol:CATI
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
 ...
 *   rescueERC20(uint256)->nonpayable
...
describe("CATI — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x1ddb23dc3a1b9ce22ba96c7ddc56b1e11e079a20.sol:CATI");
  ...
  describe("sellLimit()", function () {
    it("happy path", async function () {
      this.skip(); // TODO_AI: remove this.skip() when implementing
      // TODO_AI: Arrange -> prepare preconditions if needed
      // TODO_AI: Act -> call sellLimit() with valid inputs
      // TODO_AI: Assert -> expect correct return values
    });
