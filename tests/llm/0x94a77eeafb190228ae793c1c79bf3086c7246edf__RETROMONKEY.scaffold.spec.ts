 ...
 * ARTIFACT_SOURCE: contracts/0x94a77eeafb190228ae793c1c79bf3086c7246edf.sol
 * ARTIFACT_PATH: 0x94a77eeafb190228ae793c1c79bf3086c7246edf.sol/RETROMONKEY.json
 * ARTIFACT_FQN: contracts/0x94a77eeafb190228ae793c1c79bf3086c7246edf.sol:RETROMONKEY
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
 ...
 *   decimals()->pure
 *   manuallSwap(uint256)->nonpayable
 *   manualsend(uint256)->nonpayable
 *   name()->pure
 *   openTrading()->nonpayable
 *   owner()->view
 *   removeLimits()->nonpayable
 *   removeTrasnferLimits()->nonpayable
...
describe("RETROMONKEY — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x94a77eeafb190228ae793c1c79bf3086c7246edf.sol:RETROMONKEY");
