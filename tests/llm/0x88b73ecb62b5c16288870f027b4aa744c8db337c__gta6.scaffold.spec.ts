 ...
 * ARTIFACT_SOURCE: contracts/0x88b73ecb62b5c16288870f027b4aa744c8db337c.sol
 * ARTIFACT_PATH: 0x88b73ecb62b5c16288870f027b4aa744c8db337c.sol/gta6.json
 * ARTIFACT_FQN: contracts/0x88b73ecb62b5c16288870f027b4aa744c8db337c.sol:gta6
 *
 * FUNCTIONS:
 *   _bots(address)->view
 *   _maxTaxSwap()->view
...
describe("gta6 — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const Contract = await ethers.getContractFactory("contracts/0x88b73ecb62b5c16288870f027b4aa744c8db337c.sol:gta6");
