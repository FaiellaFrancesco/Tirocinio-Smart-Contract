 ...
 * ARTIFACT_SOURCE: contracts/0x02bc66d80e0ea8e416f2a5cfcd73cc780ff1fabe.sol
 * ARTIFACT_PATH: 0x02bc66d80e0ea8e416f2a5cfcd73cc780ff1fabe.sol/TEST.json
 * ARTIFACT_FQN: contracts/0x02bc66d80e0ea8e416f2a5cfcd73cc780ff1fabe.sol:TEST
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("TEST — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x02bc66d80e0ea8e416f2a5cfcd73cc780ff1fabe.sol:TEST");
