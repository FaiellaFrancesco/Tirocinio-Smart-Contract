 ...
 * ARTIFACT_SOURCE: contracts/0x484df4d9fce787fa2fb31c9308ec83a4cc904d2e.sol
 * ARTIFACT_PATH: 0x484df4d9fce787fa2fb31c9308ec83a4cc904d2e.sol/AIB.json
 * ARTIFACT_FQN: contracts/0x484df4d9fce787fa2fb31c9308ec83a4cc904d2e.sol:AIB
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
 ...
 *   name()->pure
 *   openTrading(uint256)->nonpayable
 *   owner()->view
...
describe("AIB — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x484df4d9fce787fa2fb31c9308ec83a4cc904d2e.sol:AIB");
