 ...
 * ARTIFACT_SOURCE: contracts/0x34ea190b204860063c5199b3f7b6f8245db91d3e.sol
 * ARTIFACT_PATH: 0x34ea190b204860063c5199b3f7b6f8245db91d3e.sol/SOBSOB.json
 * ARTIFACT_FQN: contracts/0x34ea190b204860063c5199b3f7b6f8245db91d3e.sol:SOBSOB
 *
 * FUNCTIONS:
 *   _buyCount()->view
 *   _finalBuyTax()->view
...
describe("SOBSOB — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x34ea190b204860063c5199b3f7b6f8245db91d3e.sol:SOBSOB");
