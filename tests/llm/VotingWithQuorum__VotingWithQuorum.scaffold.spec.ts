 ...
 * ARTIFACT_SOURCE: contracts/VotingWithQuorum.sol
 * ARTIFACT_PATH: VotingWithQuorum.sol/VotingWithQuorum.json
 * ARTIFACT_FQN: contracts/VotingWithQuorum.sol:VotingWithQuorum
 *
 * FUNCTIONS:
 *   addProposal(string)->nonpayable
 *   getWinningProposal()->view
 *   hasVoted(address)->view
 *   owner()->view
 *   proposals(uint256)->view
 *   quorumPercent()->view
 *   registerVoter(address)->nonpayable
 *   registeredVoters(address)->view
 *   setQuorumPercent(uint256)->nonpayable
 *   startVoting()->nonpayable
 *   totalVoters()->view
 *   vote(uint256)->nonpayable
 *   votesCast()->view
 *   votingStarted()->view
 *
 * EVENTS:
...
describe("VotingWithQuorum — AI Generated Scaffold", function () {
