 ...
 * ARTIFACT_SOURCE: contracts/0x329e337312e72beefb62e5903a0f092e0623c0b8.sol
 * ARTIFACT_PATH: 0x329e337312e72beefb62e5903a0f092e0623c0b8.sol/Muffin.json
 * ARTIFACT_FQN: contracts/0x329e337312e72beefb62e5903a0f092e0623c0b8.sol:Muffin
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("Muffin — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x329e337312e72beefb62e5903a0f092e0623c0b8.sol:Muffin");
