 ...
 * ARTIFACT_SOURCE: contracts/0xbc8defe04cd8522bf1a31f5a797269de4a0bc0b3.sol
 * ARTIFACT_PATH: 0xbc8defe04cd8522bf1a31f5a797269de4a0bc0b3.sol/Faustulus.json
 * ARTIFACT_FQN: contracts/0xbc8defe04cd8522bf1a31f5a797269de4a0bc0b3.sol:Faustulus
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("Faustulus — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xbc8defe04cd8522bf1a31f5a797269de4a0bc0b3.sol:Faustulus");
