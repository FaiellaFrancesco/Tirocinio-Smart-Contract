 ...
 * ARTIFACT_SOURCE: contracts/0x5388e83bcc5e8fc2fbeb2fe487a955f08ff47afb.sol
 * ARTIFACT_PATH: 0x5388e83bcc5e8fc2fbeb2fe487a955f08ff47afb.sol/PEPE.json
 * ARTIFACT_FQN: contracts/0x5388e83bcc5e8fc2fbeb2fe487a955f08ff47afb.sol:PEPE
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("PEPE — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x5388e83bcc5e8fc2fbeb2fe487a955f08ff47afb.sol:PEPE");
