...
/**
 * Auto-generated scaffold for OGGYTOKEN.
 * ARTIFACT_SOURCE: contracts/0x16f21ca05ef8396473ba8e7e24483fa80c60d5d6.sol
 * ARTIFACT_PATH: 0x16f21ca05ef8396473ba8e7e24483fa80c60d5d6.sol/OGGYTOKEN.json
 * ARTIFACT_FQN: contracts/0x16f21ca05ef8396473ba8e7e24483fa80c60d5d6.sol:OGGYTOKEN
 *
 * FUNCTIONS:
 *   _maxOGGYTaxSwap()->view
...
describe("OGGYTOKEN — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x16f21ca05ef8396473ba8e7e24483fa80c60d5d6.sol:OGGYTOKEN");
  ...
  describe("_maxOGGYTaxSwap()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call _maxOGGYTaxSwap() with valid inputs
