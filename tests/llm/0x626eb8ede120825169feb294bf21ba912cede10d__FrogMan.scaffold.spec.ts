 ...
 * ARTIFACT_SOURCE: contracts/0x626eb8ede120825169feb294bf21ba912cede10d.sol
 * ARTIFACT_PATH: 0x626eb8ede120825169feb294bf21ba912cede10d.sol/FrogMan.json
 * ARTIFACT_FQN: contracts/0x626eb8ede120825169feb294bf21ba912cede10d.sol:FrogMan
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("FrogMan — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x626eb8ede120825169feb294bf21ba912cede10d.sol:FrogMan");
