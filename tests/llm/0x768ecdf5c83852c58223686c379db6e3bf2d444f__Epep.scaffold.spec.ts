 ...
 * ARTIFACT_SOURCE: contracts/0x768ecdf5c83852c58223686c379db6e3bf2d444f.sol
 * ARTIFACT_PATH: 0x768ecdf5c83852c58223686c379db6e3bf2d444f.sol/Epep.json
 * ARTIFACT_FQN: contracts/0x768ecdf5c83852c58223686c379db6e3bf2d444f.sol:Epep
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("Epep — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x768ecdf5c83852c58223686c379db6e3bf2d444f.sol:Epep");
