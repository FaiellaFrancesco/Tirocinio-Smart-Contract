...
import { ZebecSilverToken, ZebecSilverToken__factory } from "../../typechain-types";
...
describe("ZebecSilverToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const factory = new ZebecSilverToken__factory(owner);
  ...
  describe("ZebecSilverVC()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call ZebecSilverVC() with valid inputs
  ...
  describe("getZebecSilverVC()", function () {
    it("happy path", async function () {
      this.skip(); // TODO_AI: remove this.skip() when implementing
      // TODO_AI: Arrange -> prepare preconditions if needed
      // TODO_AI: Act -> call getZebecSilverVC() with valid inputs
      // TODO_AI: Assert -> expect correct return values
    });
