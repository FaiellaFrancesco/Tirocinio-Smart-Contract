 ...
 * ARTIFACT_SOURCE: contracts/0x00500ccc503ffe0ec21ff4b66e322b6bd172982b.sol
 * ARTIFACT_PATH: 0x00500ccc503ffe0ec21ff4b66e322b6bd172982b.sol/Token.json
 * ARTIFACT_FQN: contracts/0x00500ccc503ffe0ec21ff4b66e322b6bd172982b.sol:Token
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _setTax_lknblTOKN(address)->nonpayable
 *   allowance(address,address)->view
 *   approve(address,uint256)->nonpayable
 *   balanceOf(address)->view
 *   decimals()->pure
 *   enableTOKNTrading()->nonpayable
 *   name()->pure
 *   owner()->view
 *   removeLimits()->nonpayable
 *   renounceOwnership()->nonpayable
 *   rescueTOKNETH()->nonpayable
 *   symbol()->pure
 *   totalSupply()->pure
...
describe("Token — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const Contract = await ethers.getContractFactory("contracts/0x00500ccc503ffe0ec21ff4b66e322b6bd172982b.sol:Token");
