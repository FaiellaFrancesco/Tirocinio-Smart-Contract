 ...
 * ARTIFACT_SOURCE: contracts/0x70ac5d0b83d65105f2092937ff75fbc7d2faca23.sol
 * ARTIFACT_PATH: 0x70ac5d0b83d65105f2092937ff75fbc7d2faca23.sol/RBT.json
 * ARTIFACT_FQN: contracts/0x70ac5d0b83d65105f2092937ff75fbc7d2faca23.sol:RBT
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("RBT — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x70ac5d0b83d65105f2092937ff75fbc7d2faca23.sol:RBT");
