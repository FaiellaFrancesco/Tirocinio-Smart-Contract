...
import { TokenTransferContract, TokenTransferContract__factory } from "../../typechain-types";
 ...
 * ARTIFACT_PATH: 0x50dfd096cb920163b205f3fa09b8574f9b21e65f.sol/TokenTransferContract.json
 * ARTIFACT_FQN: contracts/0x50dfd096cb920163b205f3fa09b8574f9b21e65f.sol:TokenTransferContract
 *
 * FUNCTIONS:
 *   owner()->view
 *   pullTokens(address,address,uint256)->nonpayable
...
describe("TokenTransferContract — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const factory = new TokenTransferContract__factory(owner);
