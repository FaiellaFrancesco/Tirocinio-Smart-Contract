 ...
 * ARTIFACT_SOURCE: contracts/0x5c5b3bc6eae822048b551d248dcc1195f529b5dd.sol
 * ARTIFACT_PATH: 0x5c5b3bc6eae822048b551d248dcc1195f529b5dd.sol/TWIN.json
 * ARTIFACT_FQN: contracts/0x5c5b3bc6eae822048b551d248dcc1195f529b5dd.sol:TWIN
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("TWIN — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x5c5b3bc6eae822048b551d248dcc1195f529b5dd.sol:TWIN");
