 ...
 * ARTIFACT_SOURCE: contracts/0xfc5b0acb1383df331bdf19b526697433cb797d81.sol
 * ARTIFACT_PATH: 0xfc5b0acb1383df331bdf19b526697433cb797d81.sol/KEKE.json
 * ARTIFACT_FQN: contracts/0xfc5b0acb1383df331bdf19b526697433cb797d81.sol:KEKE
 *
 * FUNCTIONS:
 *   _maxTaxSwap()->view
 *   _maxTxAmount()->view
...
describe("KEKE — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0xfc5b0acb1383df331bdf19b526697433cb797d81.sol:KEKE");
