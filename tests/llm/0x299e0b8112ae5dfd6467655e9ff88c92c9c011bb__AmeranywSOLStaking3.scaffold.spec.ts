 ...
 * ARTIFACT_SOURCE: contracts/0x299e0b8112ae5dfd6467655e9ff88c92c9c011bb.sol
 * ARTIFACT_PATH: 0x299e0b8112ae5dfd6467655e9ff88c92c9c011bb.sol/AmeranywSOLStaking3.json
 * ARTIFACT_FQN: contracts/0x299e0b8112ae5dfd6467655e9ff88c92c9c011bb.sol:AmeranywSOLStaking3
 *
 * FUNCTIONS:
 *   ERC(address)->nonpayable
 *   ERC20(address)->nonpayable
 *   ERC202()->nonpayable
 *   calculateInterest(address,uint256)->view
 *   claimInterestForDeposit(uint256)->nonpayable
 *   deposit(uint256,uint256,address)->nonpayable
 *   getDepositInfo(address)->view
 *   getReferral(address)->view
...
describe("AmeranywSOLStaking3 — AI Generated Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Contract = await ethers.getContractFactory("contracts/0x299e0b8112ae5dfd6467655e9ff88c92c9c011bb.sol:AmeranywSOLStaking3");
