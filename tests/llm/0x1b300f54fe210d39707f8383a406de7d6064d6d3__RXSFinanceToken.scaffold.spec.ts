...
import { RXSFinanceToken, RXSFinanceToken__factory } from "../../typechain-types";
...
describe("RXSFinanceToken — AI Generated Scaffold", function () {
  async function deployFixture() {
    ...
    const factory = new RXSFinanceToken__factory(owner);
  ...
  describe("RXSFinanceVC()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: Act -> call RXSFinanceVC() with valid inputs
  ...
  describe("getRXSFinanceVC()", function () {
    it("happy path", async function () {
      this.skip(); // TODO_AI: remove this.skip() when implementing
      // TODO_AI: Arrange -> prepare preconditions if needed
      // TODO_AI: Act -> call getRXSFinanceVC() with valid inputs
      // TODO_AI: Assert -> expect correct return values
    });
