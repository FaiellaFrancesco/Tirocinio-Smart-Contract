import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x30e341171d685b78cb456f39203d508e477e6b02.sol:HouseAI.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x30e341171d685b78cb456f39203d508e477e6b02.sol:HouseAI — LLM Scaffold", function () {
    async function deployFixture() {
      const { ethers } = (await import("hardhat")).default;
      const [owner, addr1, addr2] = await ethers.getSigners();
      const Factory = await ethers.getContractFactory("HouseAI");
