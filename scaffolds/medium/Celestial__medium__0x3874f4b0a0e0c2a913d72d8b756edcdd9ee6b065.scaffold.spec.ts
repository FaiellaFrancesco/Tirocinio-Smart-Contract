import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x3874f4b0a0e0c2a913d72d8b756edcdd9ee6b065.sol:Celestial.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x3874f4b0a0e0c2a913d72d8b756edcdd9ee6b065.sol:Celestial — LLM Scaffold", function () {
  ...
  describe("add_UKkRR(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.add_UKkRR(1n /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.add_UKkRR(0n /* TODO_AI: make invalid/edge */)
  ...
  describe("get_add_UKkRR()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_add_UKkRR();
      // TODO_AI: expect(await contract.get_add_UKkRR()).to.equal(/* atteso */);
    });
  ...
  describe("get_var_zmRmFZ()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_var_zmRmFZ();
      // TODO_AI: expect(await contract.get_var_zmRmFZ()).to.equal(/* atteso */);
    });
  ...
  describe("update_var_zmRmFZ(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.update_var_zmRmFZ(1n /* TODO_AI */);
      // TODO_AI: verifica stato/eventi dopo la tx
    });
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.update_var_zmRmFZ(0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
