...
import { loadFixture } from "@nomicfoundation/hardhat-toolbox/network-helpers";
  ...
  /**
   * Scaffold automatically generated for NewTken.
  ...
  describe("NewTken — LLM Scaffold", function () {
    ...
    // Events in ABI: AddressBlacklisted, AddressRemovedFromBlacklist, Approval, MaxTxAmountUpdated, OwnershipTransferred, Transfer
  ...
  describe("_reduceBuyTaxAt()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._reduceBuyTaxAt()).to.equal(/* atteso */);
    });
  ...
  describe("_reduceSellTaxAt()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._reduceSellTaxAt()).to.equal(/* atteso */);
    });
  ...
  describe("getBlacklist()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.getBlacklist()).to.equal(/* atteso */);
    });
  ...
  describe("isBot(address)", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.isBot(addr1.address /* TODO_AI */)).to.equal(/* atteso */);
    });
