import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x88eaa6452bdd4982d87a5d30d6e3e7b538c83ccd.sol:CONTRACT.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x88eaa6452bdd4982d87a5d30d6e3e7b538c83ccd.sol:CONTRACT — LLM Scaffold", function () {
  ...
  describe("extraForm(uint256)", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.extraForm(1n /* TODO_AI */)).to.equal(/* atteso */);
    });
  ...
  describe("firstForm(uint256)", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.firstForm(1n /* TODO_AI */)).to.equal(/* atteso */);
    });
