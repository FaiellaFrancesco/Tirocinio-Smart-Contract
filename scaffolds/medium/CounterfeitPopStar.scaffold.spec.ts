...
import { loadFixture } from "@nomicfoundation/hardhat-toolbox/network-helpers";
  ...
  /**
   * Scaffold automatically generated for CounterfeitPopStar.
  ...
  describe("CounterfeitPopStar — LLM Scaffold", function () {
    ...
    // Events in ABI: Approval, BurnRateUpdated, CooldownUpdated, DevRateUpdated, DevWalletUpdated, MarketingRateUpdated, MarketingWalletUpdated, MaxWalletUpdated, OwnershipTransferred, Transfer
