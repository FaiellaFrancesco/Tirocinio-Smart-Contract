...
/**
 * Scaffold generato automaticamente per CHEST.
...
describe("CHEST — LLM Scaffold", function () {
  ...
  describe("_maxTransaction()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._maxTransaction()).to.equal(/* atteso */);
    });
  ...
  describe("_maxWallet()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._maxWallet()).to.equal(/* atteso */);
    });
  ...
  describe("setNewFees(uint256,uint256,uint256,uint256)", function () {
    ...
    it("reverts su input/ruolo non valido", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setNewFees(0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGGIO")
    });
  ...
  describe("swapTokensAtMin(uint256)", function () {
    ...
    it("reverts su input/ruolo non valido", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.swapTokensAtMin(0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGGIO")
    });
  ...
  describe("updateTransactionAmount(uint256,uint256)", function () {
    ...
    it("reverts su input/ruolo non valido", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateTransactionAmount(0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGGIO")
    });
