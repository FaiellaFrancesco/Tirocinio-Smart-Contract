import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x7ab7cdce190d01b90ce0be6bf5b9b84962da71f4.sol:ERC20.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x7ab7cdce190d01b90ce0be6bf5b9b84962da71f4.sol:ERC20 — LLM Scaffold", function () {
    ...
    // Events in ABI: Approval, OwnershipRenounced, Transfer

    
  describe("addWLs(address[])", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.addWLs([] /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.addWLs([] /* TODO_AI: make invalid/edge */)
  ...
  describe("flipState()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.flipState();
      // TODO_AI: verifica stato/eventi dopo la tx
    });
