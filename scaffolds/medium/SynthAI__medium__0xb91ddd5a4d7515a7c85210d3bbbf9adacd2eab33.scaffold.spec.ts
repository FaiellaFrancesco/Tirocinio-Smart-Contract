import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0xb91ddd5a4d7515a7c85210d3bbbf9adacd2eab33.sol:SynthAI.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0xb91ddd5a4d7515a7c85210d3bbbf9adacd2eab33.sol:SynthAI — LLM Scaffold", function () {
  ...
  describe("add_hATLI(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.add_hATLI(1n /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.add_hATLI(0n /* TODO_AI: make invalid/edge */)
  ...
  describe("get_add_hATLI()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_add_hATLI();
      // TODO_AI: expect(await contract.get_add_hATLI()).to.equal(/* atteso */);
    });
  ...
  describe("get_var_HZNCwN()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_var_HZNCwN();
      // TODO_AI: expect(await contract.get_var_HZNCwN()).to.equal(/* atteso */);
    });
  ...
  describe("update_var_HZNCwN(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.update_var_HZNCwN(1n /* TODO_AI */);
      // TODO_AI: verifica stato/eventi dopo la tx
    });
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.update_var_HZNCwN(0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
