import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0xa47af6967b5ff3e9576d91a8430cc82ee5572a55.sol:Celestial.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0xa47af6967b5ff3e9576d91a8430cc82ee5572a55.sol:Celestial — LLM Scaffold", function () {
  ...
  describe("add_ocsSl(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.add_ocsSl(1n /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.add_ocsSl(0n /* TODO_AI: make invalid/edge */)
  ...
  describe("get_add_ocsSl()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_add_ocsSl();
      // TODO_AI: expect(await contract.get_add_ocsSl()).to.equal(/* atteso */);
    });
  ...
  describe("get_var_yFwqQU()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_var_yFwqQU();
      // TODO_AI: expect(await contract.get_var_yFwqQU()).to.equal(/* atteso */);
    });
  ...
  describe("update_var_yFwqQU(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.update_var_yFwqQU(1n /* TODO_AI */);
      // TODO_AI: verifica stato/eventi dopo la tx
    });
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.update_var_yFwqQU(0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
