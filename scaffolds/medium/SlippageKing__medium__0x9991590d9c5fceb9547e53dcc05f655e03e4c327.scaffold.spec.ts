import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x9991590d9c5fceb9547e53dcc05f655e03e4c327.sol:SlippageKing.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x9991590d9c5fceb9547e53dcc05f655e03e4c327.sol:SlippageKing — LLM Scaffold", function () {
  ...
  describe("add_EkQlJ(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.add_EkQlJ(1n /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.add_EkQlJ(0n /* TODO_AI: make invalid/edge */)
  ...
  describe("get_add_EkQlJ()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_add_EkQlJ();
      // TODO_AI: expect(await contract.get_add_EkQlJ()).to.equal(/* atteso */);
    });
  ...
  describe("get_var_PMoIIH()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_var_PMoIIH();
      // TODO_AI: expect(await contract.get_var_PMoIIH()).to.equal(/* atteso */);
    });
  ...
  describe("update_var_PMoIIH(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.update_var_PMoIIH(1n /* TODO_AI */);
      // TODO_AI: verifica stato/eventi dopo la tx
    });
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.update_var_PMoIIH(0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
