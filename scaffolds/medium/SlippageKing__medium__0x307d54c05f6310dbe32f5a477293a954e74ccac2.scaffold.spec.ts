import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/medium/0x307d54c05f6310dbe32f5a477293a954e74ccac2.sol:SlippageKing.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/medium/0x307d54c05f6310dbe32f5a477293a954e74ccac2.sol:SlippageKing — LLM Scaffold", function () {
  ...
  describe("add_TQfOX(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.add_TQfOX(1n /* TODO_AI */);
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.add_TQfOX(0n /* TODO_AI: make invalid/edge */)
  ...
  describe("get_add_TQfOX()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_add_TQfOX();
      // TODO_AI: expect(await contract.get_add_TQfOX()).to.equal(/* atteso */);
    });
  ...
  describe("get_var_PMxiGb()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.get_var_PMxiGb();
      // TODO_AI: expect(await contract.get_var_PMxiGb()).to.equal(/* atteso */);
    });
  ...
  describe("update_var_PMxiGb(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // state-changing transaction
      const result = await contract.update_var_PMxiGb(1n /* TODO_AI */);
      // TODO_AI: verifica stato/eventi dopo la tx
    });
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.update_var_PMxiGb(0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
