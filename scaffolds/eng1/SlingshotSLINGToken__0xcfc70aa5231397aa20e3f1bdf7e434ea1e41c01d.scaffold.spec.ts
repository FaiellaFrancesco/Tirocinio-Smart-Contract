...
describe("SlingshotSLINGToken — LLM Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Factory = await ethers.getContractFactory("SlingshotSLINGToken");
  ...
  describe("SlingshotSLINGVC()", function () {
    it("happy path", async function () {
      ...
      // read-only call
      const result = await contract.SlingshotSLINGVC();
      // TODO_AI: expect(await contract.SlingshotSLINGVC()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.SlingshotSLINGVC()
  ...
  describe("getSlingshotSLINGVC()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.getSlingshotSLINGVC();
      // TODO_AI: expect(await contract.getSlingshotSLINGVC()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.getSlingshotSLINGVC()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
