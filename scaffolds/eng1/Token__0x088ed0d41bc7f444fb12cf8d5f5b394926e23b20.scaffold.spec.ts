...
describe("Token — LLM Scaffold", function () {
  ...
  describe("_oijboijoiTOKN()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._oijboijoiTOKN()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._oijboijoiTOKN()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("_vnbbvlkTOKN()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._vnbbvlkTOKN()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._vnbbvlkTOKN()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
