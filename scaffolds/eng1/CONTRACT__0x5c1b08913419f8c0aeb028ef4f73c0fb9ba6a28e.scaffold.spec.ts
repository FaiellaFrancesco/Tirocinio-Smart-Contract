...
describe("CONTRACT — LLM Scaffold", function () {
  async function deployFixture() {
    ...
    const contract = await Factory.deploy("example" /* TODO_AI */, "example" /* TODO_AI */, 1n /* TODO_AI */, 1n /* TODO_AI */);
  ...
  describe("extraForm(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.extraForm(1n /* TODO_AI */);
      // TODO_AI: expect(await contract.extraForm(1n /* TODO_AI */)).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.extraForm(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("firstForm(uint256)", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.firstForm(1n /* TODO_AI */);
      // TODO_AI: expect(await contract.firstForm(1n /* TODO_AI */)).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.firstForm(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
