...
/**
 * Auto-generated scaffold for ChatPTG.
 * TODO_AI blocks should be completed by the LLM.
 */

describe("ChatPTG — LLM Scaffold", function () {
  ...
  describe("_ChatPTGThres()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._ChatPTGThres()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._ChatPTGThres()
  ...
  describe("_ChatPTGamount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._ChatPTGamount()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._ChatPTGamount()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
