...
import { loadFixture } from "@nomicfoundation/hardhat-toolbox/network-helpers";
  ...
  /**
   * Scaffold automatically generated for HYPE.
  ...
  describe("airdropToWallets(address[],uint256[])", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.airdropToWallets([] /* TODO_AI: rendi invalido/edge */, [] /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("bot(address)", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.bot(addr1.address /* TODO_AI */)).to.equal(/* atteso */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.bot("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("botsCaught()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.botsCaught()).to.equal(/* atteso */);
    });
  ...
  describe("buyOperationsFee()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.buyOperationsFee()).to.equal(/* atteso */);
    });
  ...
  describe("manageBoughtEarly(address,bool)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.manageBoughtEarly("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */, false /* TODO_AI */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("massManageBoughtEarly(address[],bool)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.massManageBoughtEarly([] /* TODO_AI: rendi invalido/edge */, false /* TODO_AI */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("maxBuyAmount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.maxBuyAmount()).to.equal(/* atteso */);
    });
  ...
  describe("maxSellAmount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.maxSellAmount()).to.equal(/* atteso */);
    });
  ...
  describe("maxWalletAmount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.maxWalletAmount()).to.equal(/* atteso */);
    });
  ...
  describe("sellOperationsFee()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.sellOperationsFee()).to.equal(/* atteso */);
    });
  ...
  describe("setOperationsAddress(address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setOperationsAddress("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("tokensForOperations()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.tokensForOperations()).to.equal(/* atteso */);
    });
  ...
  describe("transferForeignToken(address,address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.transferForeignToken("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */, "0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateBuyFees(uint256,uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateBuyFees(0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateMaxBuyAmount(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateMaxBuyAmount(0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateMaxSellAmount(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateMaxSellAmount(0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateMaxWalletAmount(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateMaxWalletAmount(0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateSellFees(uint256,uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateSellFees(0n /* TODO_AI: rendi invalido/edge */, 0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("updateSwapTokensAtAmount(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.updateSwapTokensAtAmount(0n /* TODO_AI: rendi invalido/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
