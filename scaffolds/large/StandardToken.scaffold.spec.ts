...
describe("StandardToken — LLM Scaffold", function () {
  async function deployFixture() {
    ...
    const contract = await Factory.deploy("example" /* TODO_AI */, "example" /* TODO_AI */, 1n /* TODO_AI */, 1n /* TODO_AI */, addr1.address /* TODO_AI */, 1n /* TODO_AI */);
  ...
  // Eventi in ABI: Approval, OwnershipTransferred, TokenCreated, Transfer
