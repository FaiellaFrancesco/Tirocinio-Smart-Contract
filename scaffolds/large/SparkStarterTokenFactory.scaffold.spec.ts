...
import { loadFixture } from "@nomicfoundation/hardhat-toolbox/network-helpers";
  ...
  /**
   * Scaffold automatically generated for SparkStarterTokenFactory.
  ...
  describe("authorizedChecker()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.authorizedChecker()).to.equal(/* atteso */);
    });
  ...
  describe("vaultFactory()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.vaultFactory()).to.equal(/* atteso */);
    });
