...
import { loadFixture } from "@nomicfoundation/hardhat-toolbox/network-helpers";
  ...
  /**
   * Scaffold automatically generated for Team.
  ...
  describe("Team — LLM Scaffold", function () {
    ...
    // Events in ABI: Initialized, OwnershipTransferred, ReleaseAllocation
  ...
  describe("balance()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.balance()).to.equal(/* atteso */);
    });
  ...
  describe("eachReleaseAmount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.eachReleaseAmount()).to.equal(/* atteso */);
    });
  ...
  describe("initialize(address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.initialize("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("isFirstRelease()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.isFirstRelease()).to.equal(/* atteso */);
    });
  ...
  describe("lastTimeRelease()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.lastTimeRelease()).to.equal(/* atteso */);
    });
  ...
  describe("nextTimeRelease()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.nextTimeRelease()).to.equal(/* atteso */);
    });
  ...
  describe("releasePeriod()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.releasePeriod()).to.equal(/* atteso */);
    });
  ...
  describe("remainingAmount()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.remainingAmount()).to.equal(/* atteso */);
    });
  ...
  describe("totalAllocation()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.totalAllocation()).to.equal(/* atteso */);
    });
  ...
  describe("withdrawAdmin(address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.withdrawAdmin("0x0000000000000000000000000000000000000000" /* TODO_AI: usa zero/non autorizzato */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
