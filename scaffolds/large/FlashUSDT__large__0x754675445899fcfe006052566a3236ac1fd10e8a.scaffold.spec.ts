import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/large/0x754675445899fcfe006052566a3236ac1fd10e8a.sol:FlashUSDT.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/large/0x754675445899fcfe006052566a3236ac1fd10e8a.sol:FlashUSDT — LLM Scaffold", function () {
  ...
  describe("burnFrom(address,uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.burnFrom("0x0000000000000000000000000000000000000000" /* TODO_AI: use zero/unauthorized */, 0n /* TODO_AI: make invalid/edge */)
      ).to.be.revertedWith(/* TODO_AI: inserire messaggio */);
    });
