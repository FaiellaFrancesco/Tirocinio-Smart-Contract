import { expect } from "chai";
  ...
  /**
   * Scaffold automatically generated for contracts/large/0x478813ea4b488d560b525c562cbb352aa99573d8.sol:MyToken.
   * Blocks marked // TODO_AI must be completed by the LLM.
   */

  describe("contracts/large/0x478813ea4b488d560b525c562cbb352aa99573d8.sol:MyToken — LLM Scaffold", function () {
  ...
  describe("TELEGRAM_LINK()", function () {
    it("happy path", async function () {
      ...
      // read-only call
      const result = await contract.TELEGRAM_LINK();
      // TODO_AI: expect(await contract.TELEGRAM_LINK()).to.equal(/* atteso */);
    });
  ...
  describe("WEBSITE_LINK()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.WEBSITE_LINK();
      // TODO_AI: expect(await contract.WEBSITE_LINK()).to.equal(/* atteso */);
    });
