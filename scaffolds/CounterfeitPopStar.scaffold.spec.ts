...
describe("CounterfeitPopStar — LLM Scaffold", function () {
  ...
  describe("TOTAL_SUPPLY()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.TOTAL_SUPPLY()).to.equal(/* expected */);
    });
  ...
  describe("burnRate()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.burnRate()).to.equal(/* expected */);
    });
  ...
  describe("cooldownTime()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.cooldownTime()).to.equal(/* expected */);
    });
  ...
  describe("devRate()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.devRate()).to.equal(/* expected */);
    });
  ...
  describe("getSecondsUntilNextTransfer(address)", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.getSecondsUntilNextTransfer(addr1.address /* TODO_AI */)).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.getSecondsUntilNextTransfer("0x0000000000000000000000000000000000000000" /* TODO_AI: use zero/unauthorized */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("marketingRate()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.marketingRate()).to.equal(/* expected */);
    });
  ...
  describe("maxWalletPercent()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.maxWalletPercent()).to.equal(/* expected */);
    });
  ...
  describe("setBurnRate(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setBurnRate(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setCooldownTime(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setCooldownTime(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setDevRate(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setDevRate(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setDevWallet(address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setDevWallet("0x0000000000000000000000000000000000000000" /* TODO_AI: use zero/unauthorized */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setMarketingRate(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setMarketingRate(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setMarketingWallet(address)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setMarketingWallet("0x0000000000000000000000000000000000000000" /* TODO_AI: use zero/unauthorized */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("setMaxWalletPercent(uint256)", function () {
    ...
    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.setMaxWalletPercent(0n /* TODO_AI: make invalid/edge */)
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
