...
describe("Token — LLM Scaffold", function () {
  ...
  describe("_oijboijoiOMG()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._oijboijoiOMG()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._oijboijoiOMG()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("_vnbbvlOMGK()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract._vnbbvlOMGK()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract._vnbbvlOMGK()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
