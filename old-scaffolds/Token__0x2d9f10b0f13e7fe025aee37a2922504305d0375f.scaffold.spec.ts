...
describe("Token — LLM Scaffold", function () {
  async function deployFixture() {
    ...
    const contract = await Factory.deploy("example" /* TODO_AI */, "example" /* TODO_AI */, 1n /* TODO_AI */);
  ...
  describe("MODE_NORMAL()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.MODE_NORMAL()).to.equal(/* expected */);
    });
  ...
  describe("MODE_TRANSFER_CONTROLLED()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.MODE_TRANSFER_CONTROLLED()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.MODE_TRANSFER_CONTROLLED()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
  ...
  describe("MODE_TRANSFER_RESTRICTED()", function () {
    it("happy path", async function () {
      ...
      // TODO_AI: expect(await contract.MODE_TRANSFER_RESTRICTED()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.MODE_TRANSFER_RESTRICTED()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
