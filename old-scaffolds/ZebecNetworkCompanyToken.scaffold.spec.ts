...
describe("ZebecNetworkCompanyToken — LLM Scaffold", function () {
  async function deployFixture() {
    const [owner, addr1, addr2] = await ethers.getSigners();
    const Factory = await ethers.getContractFactory("ZebecNetworkCompanyToken");
    // TODO_AI: complete constructor parameters if any
    const contract = await Factory.deploy("example" /* TODO_AI */, "example" /* TODO_AI */, 1n /* TODO_AI */, 1n /* TODO_AI */, addr1.address /* TODO_AI */, addr1.address /* TODO_AI */);
  ...
  describe("ZebecNetworkCompanyVC()", function () {
    it("happy path", async function () {
      ...
      // read-only call
      const result = await contract.ZebecNetworkCompanyVC();
      // TODO_AI: expect(await contract.ZebecNetworkCompanyVC()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.ZebecNetworkCompanyVC()
  ...
  describe("getZebecNetworkCompanyVC()", function () {
    it("happy path", async function () {
      const { contract, owner, addr1, addr2 } = await loadFixture(deployFixture);
      // read-only call
      const result = await contract.getZebecNetworkCompanyVC();
      // TODO_AI: expect(await contract.getZebecNetworkCompanyVC()).to.equal(/* expected */);
    });

    it("reverts on invalid input/role", async function () {
      const { contract } = await loadFixture(deployFixture);
      await expect(
        contract.getZebecNetworkCompanyVC()
      ).to.be.reverted; // TODO_AI: .with("MESSAGE")
    });
